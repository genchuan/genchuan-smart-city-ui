...
import type { MemberGroupVO } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberGroup';
...
import { MemberGroupApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberGroup';
