...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row"><div class="detail-row-left">预约时间：</div><div class="detail-row-right">{{ detailObj.reserveTime || '-' }}</div></div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">审核时间：</div><div class="detail-row-right">{{ detailObj.auditTime || '-' }}</div></div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">完成时间：</div><div class="detail-row-right">{{ detailObj.finishTime || '-' }}</div></div>
