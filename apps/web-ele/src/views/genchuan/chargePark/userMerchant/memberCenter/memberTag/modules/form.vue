...
import type { MemberTagVO } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberTag';
...
import { MemberTagApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberTag';
