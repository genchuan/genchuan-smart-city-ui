  ...
  if (id) {
    ...
    try {
      ...
      formData.value = {
        ...res,
        // 将字符串时间戳转为数字
        disposalStartTime: res.disposalStartTime
          ? Number(res.disposalStartTime)
          : undefined,
        disposalEndTime: res.disposalEndTime
          ? Number(res.disposalEndTime)
          : undefined,
      };
    } finally {
  ...
  >
    ...
    >
      ...
      <ElFormItem label="处理部门" prop="disposalDepartment">
        <ElInput
          v-model="formData.disposalDepartment"
          placeholder="请输入处理部门"
        />
      </ElFormItem>
      ...
      <ElFormItem label="处理依据" prop="disposalBasis">
        <ElInput
          v-model="formData.disposalBasis"
          placeholder="请输入处理依据"
        />
      </ElFormItem>
      <ElFormItem label="处理内容" prop="disposalContent">
        <ElInput
          v-model="formData.disposalContent"
          type="textarea"
          placeholder="请输入处理内容"
        />
      </ElFormItem>
