  ...
  >
    ...
    >
      ...
      <ElFormItem label="巡查任务完成率" prop="completionInspectionTasks">
        <ElInput
          v-model="formData.completionInspectionTasks"
          placeholder="请输入巡查任务完成率"
        />
      </ElFormItem>
      <ElFormItem label="平均巡查时长" prop="averagePatrolDuration">
        <ElInput
          v-model="formData.averagePatrolDuration"
          placeholder="请输入平均巡查时长"
        />
      </ElFormItem>
      <ElFormItem label="问题发现数量" prop="numberProblemDiscoveries">
        <ElInput
          v-model="formData.numberProblemDiscoveries"
          placeholder="请输入问题发现数量"
        />
      </ElFormItem>
      <ElFormItem label="不同类型问题分布" prop="distributionProblems">
        <ElInput
          v-model="formData.distributionProblems"
          placeholder="请输入不同类型问题分布"
        />
      </ElFormItem>
      <ElFormItem label="问题解决率" prop="problemSolvingRate">
        <ElInput
          v-model="formData.problemSolvingRate"
          placeholder="请输入问题解决率"
        />
      </ElFormItem>
      <ElFormItem label="重复问题发生率" prop="repetitiveProblemRate">
        <ElInput
          v-model="formData.repetitiveProblemRate"
          placeholder="请输入重复问题发生率"
        />
      </ElFormItem>
      <ElFormItem label="风险等级评估" prop="riskLevelAssessment">
        <ElInput
          v-model="formData.riskLevelAssessment"
          placeholder="请输入风险等级评估"
        />
      </ElFormItem>
      <ElFormItem label="建议与改进措施" prop="suggestionsMeasures">
        <ElInput
          v-model="formData.suggestionsMeasures"
          placeholder="请输入建议与改进措施"
        />
      </ElFormItem>
    </ElForm>
    <template #footer>
