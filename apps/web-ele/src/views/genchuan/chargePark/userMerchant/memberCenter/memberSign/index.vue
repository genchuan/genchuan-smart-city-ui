...
import type {
  MemberSignPageReqVO,
  MemberSignVO,
} from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberSign';
...
import { MemberSignApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberSign';
