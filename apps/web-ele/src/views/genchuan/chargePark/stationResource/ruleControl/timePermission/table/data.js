...
export const searchFields = [
  ...
  { field: 'permission', label: '准入权限', type: 'input', required: false },
  {
    field: 'status',
    label: '状态',
    type: 'select',
...
export const formFields = [
  ...
  { field: 'permission', label: '准入权限', type: 'input', required: true },
  { field: 'maxStay', label: '最长停留时长', type: 'number', required: false },
  { field: 'workdayConfig', label: '工作日配置', type: 'input', required: false },
  { field: 'holidayConfig', label: '节假日配置', type: 'input', required: false },
  { field: 'peakConfig', label: '高峰时段配置', type: 'input', required: false },
  { field: 'offpeakConfig', label: '平峰时段配置', type: 'input', required: false },
...
export const tableColumns = [
  ...
  { field: 'permission', label: '准入权限', minWidth: 140, drillType: 'filter' },
  { field: 'maxStay', label: '最长停留时长', minWidth: 120 },
  { field: 'useCount', label: '使用次数', minWidth: 120, drillType: 'dialog', drillLabel: '规则使用明细' },
...
export const detailFields = [
  ...
  { key: 'stationId', label: '所属场站ID', section: '规则内容' },
