<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="资质证书编号" label-width="auto" prop="certificateNo">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:testing-agency:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:testing-agency:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="机构编号" align="center" prop="agencyCode" />
      <el-table-column label="机构名称" align="center" prop="agencyName" />
      <el-table-column label="资质证书编号" align="center" prop="certificateNo" />
      ...
      <el-table-column
        ...
        width="180px"
      />
      <el-table-column label="发证单位" align="center" prop="issuingAuthority" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['waterdetection:testing-agency:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['waterdetection:testing-agency:delete']"
          >
            删除
          </el-button>
        </template>
...
import { TestingAgencyApi, TestingAgencyVO } from '@/api/waterdetection/testingagency'
...
const list = ref<TestingAgencyVO[]>([]) // 列表的数据
