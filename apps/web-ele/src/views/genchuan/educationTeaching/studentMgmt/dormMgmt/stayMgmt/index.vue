...
import {
  ...
  getColumns,
  useApplyFormSchema,
} from '#/api/genchuan/educationTeaching/studentMgmt/dormMgmt/stayMgmt/form.js';
...
async function handleEdit(row) {
  ...
  try {
    const detail = await getStayMgmtDetail({ id: row.id });
    applyFormApi.setValues({
      studentId: detail.studentId,
      stayDate: stayDateToTimestamp(detail.stayDate),
      stayReason: detail.stayReason,
      applyTime: detail.applyTime,   // 补充申请时间赋值
