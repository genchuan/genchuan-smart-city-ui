...
import BatchImport from './importBatch.vue';

// 图片上传接口（已提供）
import { uploadImageBatch } from '#/api/genchuan/industry/urbanmanagement/environmentalSanitation/sanitationSceneMgmt/garbageCollection/data.js';
