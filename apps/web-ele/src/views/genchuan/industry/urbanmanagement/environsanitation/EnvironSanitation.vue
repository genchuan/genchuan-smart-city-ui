<template>
  <div class="environ-sanitation-container" ref="pageContainerRef">
    <div class="page-header">
      <h1>
        <img
          src="../images/environ-sanitation.png"
          alt="环境卫生图标"
          class="title-icon"
        />
        环境卫生专题
...
} from '#/api/genchuan/industry/urbanmanagement/SubdomainScenarioTopics.js';
