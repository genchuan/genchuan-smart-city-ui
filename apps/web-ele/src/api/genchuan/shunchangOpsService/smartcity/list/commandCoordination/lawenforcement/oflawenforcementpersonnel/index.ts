...
export const OfLawEnforcementPersonnelApi = {
  ...
  getOfLawEnforcementPersonnelPage: async (params: any) => {
    return await requestClient.get(`/smartcity/of-law-enforcement-personnel/page`, { params });
  },

  // 查询执法人员管理详情
  getOfLawEnforcementPersonnel: async (id: number) => {
    return await requestClient.get(`/smartcity/of-law-enforcement-personnel/get`, { params: { id } });
  },

  // 新增执法人员管理
  createOfLawEnforcementPersonnel: async (data: any) => {
    return await requestClient.post(`/smartcity/of-law-enforcement-personnel/create`, data);
  },

  // 修改执法人员管理
  updateOfLawEnforcementPersonnel: async (data: any) => {
    return await requestClient.put(`/smartcity/of-law-enforcement-personnel/update`, data);
  },

  // 删除执法人员管理
  deleteOfLawEnforcementPersonnel: async (id: number) => {
    return await requestClient.delete(`/smartcity/of-law-enforcement-personnel/delete`, { params: { id } });
  },

  // 导出执法人员管理 Excel
  exportOfLawEnforcementPersonnel: async (params) => {
    return await requestClient.download(`/smartcity/of-law-enforcement-personnel/export-excel`, params);
  },
};
