...
const actionConfig = {
  disable: {
    title: '确认禁用',
    message: (name) =>
      `确定要禁用电子围栏“${name}”吗？禁用后将关闭越界告警功能。`,
    successMessage: '电子围栏禁用成功',
    loadingMessage: '正在禁用电子围栏...',
    api: disableFenceMgmt,
  },
  enable: {
    title: '确认生效',
    message: (name) =>
      `确定要生效电子围栏“${name}”吗？生效后将开启越界告警功能。`,
    successMessage: '电子围栏生效成功',
    loadingMessage: '正在生效电子围栏...',
    api: enableFenceMgmt,
  },
};
...
async function handleConfirm() {
  ...
  try {
    ...
    console.error('电子围栏状态操作失败:', error);
...
<template>
  <Modal>
    <div class="confirm-container">
      ...
      <div class="confirm-tip">确认后将刷新电子围栏列表。</div>
    </div>
  </Modal>
</template>
