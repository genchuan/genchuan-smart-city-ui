...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">本周总告警次数:</div>
        <div class="detail-row-right">
          {{ detailObj.weekWarnCount || 0 }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">本周违规企业数量:</div>
        <div class="detail-row-right">
          {{ detailObj.weekIllegalEntCount || 0 }}
        </div>
      </div>
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">时段违规分布:</div>
        <div class="detail-row-right">
          {{ detailObj.timeIllegalDist || '-' }}
        </div>
      </div>
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">本周整改完成率:</div>
        <div class="detail-row-right">
          {{ detailObj.weekRectifyRate || 0 }} %
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">本周设备正常率:</div>
        <div class="detail-row-right">
          {{ detailObj.weekDeviceNormalRate || 0 }} %
        </div>
      </div>
    </div>
  </DetailDrawer>
