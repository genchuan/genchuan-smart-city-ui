      ...
      <div class="top-layout">
        ...
        <div class="top_middle">
          <div class="panel force-distribution-panel" ref="mapPanel">
            <div class="panel-header">
              <h2><el-icon><MapLocation /></el-icon> 综合力量分布视图</h2>
        ...
        <div class="top_right">
          <div class="panel" ref="regionPatternPanel" style="height: 100%;">
            <div class="panel-header">
              <h2><el-icon><DataAnalysis /></el-icon> 综合全域数据</h2>
...
import ChartPie3 from './ChartPie2.vue';
...
} from '#/api/genchuan/industry/comprehensivelaw/GlobalSituationOverview.js';
...
const getStatAnalysis = (statId) => {
  const analysisMap = {
    1: '当前案件总数反映了辖区内的工作总量，较上月增长8%，表明执法活动较为活跃。',
    2: '人员数量保持稳定，新增人员主要充实到一线岗位。',
    3: '设备在线率略有下降，建议检查设备维护情况。',
...
// 滚动条样式（使用公共样式中的custom-scrollbar mixin）
.page-container {
