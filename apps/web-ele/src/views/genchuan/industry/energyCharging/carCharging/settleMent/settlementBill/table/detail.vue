  ...
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row">
        ...
        <div class="detail-row-right">{{ detailObj.settlementCycle || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">总结算金额:</div>
        <div class="detail-row-right">{{ detailObj.settlementAmount || '-' }}</div>
      </div>
      <div class="detail-card-row">
      ...
      <div class="detail-card-row">
        ...
        <div class="detail-row-right">{{ detailObj.settlementTime || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">结算渠道:</div>
        <div class="detail-row-right">{{ detailObj.settlementChannel || '-' }}</div>
      </div>
      <div class="detail-card-row">
