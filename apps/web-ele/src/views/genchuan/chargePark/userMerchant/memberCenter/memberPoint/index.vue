...
import type {
  ...
  MemberPointVO,
} from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberPoint';
...
import { MemberPointApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberPoint';
