<template>
  <div class="page-container" ref="pageContainerRef">
    ...
    <div class="mainbox">
      <div class="left" style="min-width: 20vw;">
        <!-- 交通资源分布 -->
      ...
      <div class="middle" style="min-width: 20vw;">
...
import {
  ...
  handleAbnormal
} from '#/api/genchuan/industry/transportation/overview/GlobalSituationOverview.js';
...
const loadSubIndicatorTrend = async (subCode) => {
  ...
  indicatorHistoryData.value = await fetchIndicatorHistory(sub.code, sub.target);
};
...
const generateFlowTrendData = async (flowId) => {
  try {
    flowTrendData.value = await fetchFlowTrend(flowId);
  } catch (error) {
