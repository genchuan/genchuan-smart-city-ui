...
export function importParkingSpaceInfo(file) {
...
function buildPieData(cardData) {
  return [
    { name: '已绑定', count: cardData.bindSpace || 0 },
    { name: '未绑定', count: cardData.unbindSpace || 0 },
    { name: '已禁用', count: cardData.disableSpace || 0 },
