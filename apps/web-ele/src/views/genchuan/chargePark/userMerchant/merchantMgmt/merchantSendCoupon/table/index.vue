...
} from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantSendCoupon';
...
import { MerchantSendCouponApi } from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantSendCoupon';
