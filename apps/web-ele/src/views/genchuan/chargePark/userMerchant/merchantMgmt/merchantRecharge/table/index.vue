...
} from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantRecharge';
...
import { MerchantRechargeApi } from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantRecharge';
