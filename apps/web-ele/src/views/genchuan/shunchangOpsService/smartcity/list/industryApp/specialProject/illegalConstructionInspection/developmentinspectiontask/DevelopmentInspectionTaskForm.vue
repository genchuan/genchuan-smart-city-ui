...
import { DevelopmentInspectionTaskApi } from '#/api/genchuan/shunchangOpsService/smartcity/list/industryApp/specialProject/illegalConstructionInspection/developmentinspectiontask';
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value =
        await DevelopmentInspectionTaskApi.getDevelopmentInspectionTask(id);
    } finally {
  ...
  >
    ...
    >
      ...
      <ElFormItem label="发现的问题" prop="foundProblems">
        <ElInput
          v-model="formData.foundProblems"
