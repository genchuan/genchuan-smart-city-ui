...
// 绿化类型图标
import markerTree from '../images/tree.png';         // 树木-绿色
import markerGreenSpace from '../images/greenspace.png'; // 绿地-深绿
import markerFlowerBed from '../images/flowerbed.png'; // 花坛-紫色
import markerDisease from '../images/disease.png';   // 病害-红色感叹号
