  ...
  return requestClient.get('/securitymgmt/real-time-monitor/chart').catch(err => {
    ...
    return Promise.resolve({
      ...
      cameraMapList: [
        ...
        { id: 2, cameraName: '办公楼东摄像头', lon: 118.678, lat: 24.898, runStatus: '正常' },
        { id: 3, cameraName: '办公楼西摄像头', lon: 118.676, lat: 24.897, runStatus: '异常' },
        { id: 4, cameraName: '车间A摄像头', lon: 118.672, lat: 24.892, runStatus: '正常' },
        { id: 5, cameraName: '仓库北摄像头', lon: 118.680, lat: 24.893, runStatus: '正常' },
        { id: 6, cameraName: '停车场南摄像头', lon: 118.682, lat: 24.890, runStatus: '离线' },
      ],
    });
  });
}
  ...
  return [
    {
      ...
      streamUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', // 测试MP4地址
      handleUser: 'admin',
      handleResult: null,
      snapImg: null,
      creator: 'admin',
