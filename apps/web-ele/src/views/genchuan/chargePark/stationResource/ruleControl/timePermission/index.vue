...
import * as pageApi from '#/api/genchuan/chargePark/stationResource/ruleControl/timePermission/index.js';
import * as areaApi from '#/api/genchuan/chargePark/stationResource/areaMgmt/areaInfo/index.js';
import * as stationConfigApi from '#/api/genchuan/chargePark/stationResource/stationMgmt/stationConfig/index.js';
