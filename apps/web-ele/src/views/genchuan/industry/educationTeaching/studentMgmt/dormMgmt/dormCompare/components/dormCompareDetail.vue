...
const drawerTitle = computed(() => {
  const name = detailObj.value?.dormNum ? `${detailObj.value.dormNum} 宿舍评比` : '评比详情';
...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row"><div class="detail-row-left">得分：</div><div class="detail-row-right">{{ detailObj.score || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">排名：</div><div class="detail-row-right">{{ detailObj.rankNo || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">打分人：</div><div class="detail-row-right">{{ detailObj.scoreUser || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">汇总时间：</div><div class="detail-row-right">{{ formatTimestamp(detailObj.sumTime) }}</div></div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">当前排名：</div><div class="detail-row-right">{{ detailObj.rankNo || '-' }}</div></div>
