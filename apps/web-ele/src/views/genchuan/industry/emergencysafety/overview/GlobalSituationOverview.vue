<template>
  <div class="page-container" ref="pageContainerRef">
    ...
    <div class="mainbox">
      ...
      <div class="panel right" style="min-width: 2vw;">
        <div class="panel-header">
          <h2>应急资源总览</h2>
          <div class="header-actions">
            <!-- 资源类型筛选 -->
...
} from '#/api/genchuan/industry/emergencysafety/overview/GlobalSituationOverview.js';
...
const refreshCoreIndicators = async () => {
  try {
    ...
    // 转换数据格式（包含所有字段）
    coreIndicators.value = transformCoreIndicators(data);
