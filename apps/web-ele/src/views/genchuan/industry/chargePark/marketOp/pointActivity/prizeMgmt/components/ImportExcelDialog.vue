...
import { importPrizeMgmt } from '#/api/genchuan/industry/chargePark/marketOp/pointActivity/prizeMgmt';
...
const handleImport = async () => {
  ...
  try {
    ...
    // 调用导入接口
    const response = await importPrizeMgmt(file);
