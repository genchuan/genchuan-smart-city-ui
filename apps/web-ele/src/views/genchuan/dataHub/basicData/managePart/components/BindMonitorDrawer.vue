  ...
  <Drawer>
    <div class="bind-monitor-container">
      ...
      <div class="monitor-list">
        <div class="list-header">
          <ElCheckbox
            :model-value="
              selectedMonitors.length === filteredMonitorList().length &&
            ...
            @change="
              (val: any) =>
                (selectedMonitors = val
                  ? filteredMonitorList().map((item) => item.id)
                  : [])
            "
          >
            全选
          ...
          <span class="selected-count"
            >已选择 {{ selectedMonitors.length }} 个</span
          >
        </div>
        ...
        <div class="list-content">
          ...
          >
            ...
            <div class="monitor-status-group">
              ...
              <div v-if="boundMonitors.includes(item.id)" class="bound-tag">
                已关联
              </div>
            </div>
          </div>
    ...
    <template #footer>
      <div class="drawer-footer">
        ...
        <ElButton type="primary" @click="handleConfirm"> 确认绑定 </ElButton>
      </div>
    </template>
  </Drawer>
</template>
