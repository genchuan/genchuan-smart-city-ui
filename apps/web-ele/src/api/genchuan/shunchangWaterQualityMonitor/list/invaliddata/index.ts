...
export const InvalidDataApi = {
  ...
  getInvalidDataPage: async (params: any) => {
    return await requestClient.get(`/waterdetection/invalid-data/page`, {
      params,
    });
  },
  ...
  getInvalidData: async (id: number) => {
    return await requestClient.get(`/waterdetection/invalid-data/get`, {
      params: { id },
    });
  },
  ...
  updateInvalidData: async (data: any) => {
    return await requestClient.put(`/waterdetection/invalid-data/update`, data);
  },

  // 删除不合格数据处理
  deleteInvalidData: async (id: number) => {
    return await requestClient.delete(`/waterdetection/invalid-data/delete`, {
      params: { id },
    });
  },
