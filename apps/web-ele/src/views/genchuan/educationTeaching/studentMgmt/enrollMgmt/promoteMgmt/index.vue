...
} from '#/api/genchuan/educationTeaching/studentMgmt/enrollMgmt/promoteMgmt/data.js';
import {
  textObj,
  useFormSchema,
  getColumns,
...
} from '#/api/genchuan/educationTeaching/studentMgmt/enrollMgmt/promoteMgmt/form.js';
