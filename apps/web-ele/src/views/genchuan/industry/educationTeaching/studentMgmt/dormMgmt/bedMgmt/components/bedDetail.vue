...
const drawerTitle = computed(() => {
  const name = detailObj.value?.roomNum ? `${detailObj.value.building} ${detailObj.value.roomNum} ${detailObj.value.bedNum}` : '床位';
...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      <!-- 基础信息 -->
      <div class="detail-section">🛏️ 床位基础信息</div>
      <div class="detail-card-row"><div class="detail-row-left">楼栋：</div><div class="detail-row-right">{{ detailObj.building || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">楼层：</div><div class="detail-row-right">{{ detailObj.floor || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">房间号：</div><div class="detail-row-right">{{ detailObj.roomNum || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">床位号：</div><div class="detail-row-right">{{ detailObj.bedNum || '-' }}</div></div>
