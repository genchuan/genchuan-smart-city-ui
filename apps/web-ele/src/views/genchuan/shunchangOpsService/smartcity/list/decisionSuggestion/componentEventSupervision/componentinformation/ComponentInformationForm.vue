  ...
  <ElDialog :title="dialogTitle" v-model="dialogVisible" width="600px" append-to-body>
    ...
    >
      ...
      <ElFormItem label="部件名称" prop="componentName">
        <ElInput v-model="formData.componentName" placeholder="请输入部件名称" />
      </ElFormItem>
      ...
      <ElFormItem label="所属区域" prop="belongingRegion">
        <ElInput v-model="formData.belongingRegion" placeholder="请输入所属区域" />
      </ElFormItem>
      <ElFormItem label="安装位置" prop="installationPosition">
        <ElInput v-model="formData.installationPosition" placeholder="请输入安装位置" />
      </ElFormItem>
      ...
      <ElFormItem label="管理部门" prop="administrativeDepartment">
        <ElInput v-model="formData.administrativeDepartment" placeholder="请输入管理部门" />
      </ElFormItem>
      <ElFormItem label="维护单位" prop="maintenanceUnit">
        <ElInput v-model="formData.maintenanceUnit" placeholder="请输入维护单位" />
      </ElFormItem>
      <ElFormItem label="联系电话" prop="contactNumber">
        <ElInput v-model="formData.contactNumber" placeholder="请输入联系电话" />
      </ElFormItem>
      <ElFormItem label="部件状态" prop="componentStatus">
        <ElSelect v-model="formData.componentStatus" placeholder="请选择部件状态">
          <ElOption
      ...
      <ElFormItem label="关联事件记录" prop="relatedEventRecords">
        <ElInput v-model="formData.relatedEventRecords" placeholder="请输入关联事件记录" />
      </ElFormItem>
    </ElForm>
    <template #footer>
