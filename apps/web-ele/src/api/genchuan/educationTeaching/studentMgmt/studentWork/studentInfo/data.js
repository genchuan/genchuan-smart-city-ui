...
export function getStudentInfoPage(params) {
  ...
  return requestClient
    .get('/studentmgmt/student-info/page', { params: convertedParams })
    .then((res) => {
      if (res && res.list) {
...
export function createStudentInfo(data) {
  ...
  return requestClient
    .post('/studentmgmt/student-info/create', convertedData)
    .catch((error) => {
...
export function updateStudentInfo(data) {
  const convertedData = convertZhToEn(data);
  return requestClient
    .put('/studentmgmt/student-info/update', convertedData)
    .catch((error) => {
...
export function deleteStudentInfo(params) {
  return requestClient
    .delete('/studentmgmt/student-info/delete', { params })
    .catch((error) => {
      console.warn('删除接口失败，模拟成功', error);
      return true;
    });
}
...
export function deleteStudentInfoList(data) {
  return requestClient
    .delete('/studentmgmt/student-info/delete-list', { params: data })
    .catch((error) => {
      console.warn('批量删除接口失败，模拟成功', error);
      return true;
    });
}
...
export function exportStudentInfo(params) {
  const convertedParams = convertZhToEn(params);
  return requestClient
    .download('/studentmgmt/student-info/export', convertedParams)
    .catch((error) => {
...
export function getStudentInfoDetail(params) {
  return requestClient
    .get('/studentmgmt/student-info/get', { params })
...
export function getStudentInfoChart(params) {
  return requestClient
    .get('/studentmgmt/student-info/chart', { params })
    .catch((error) => {
...
export function getStudentInfoDistribution(params) {
  return requestClient
    .get('/studentmgmt/student-info/chart/distributionCount', { params })
    .catch((error) => {
      console.warn('分布统计接口失败，使用模拟数据', error);
      ...
      return mockDistribution[dimension] || [];
    });
}

export function getStudentInfoCoreIndex(params) {
  return requestClient
    .get('/studentmgmt/student-info/chart/coreIndex', { params })
    .catch((error) => {
