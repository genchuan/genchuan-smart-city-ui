...
<template>
  <DetailDrawer :title="title || `运营详情 - ${detailObj.areaName} ${detailObj.parkType}`">
    <div class="detail-card">
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">预警总数:</div>
        <div class="detail-row-right">
          <el-tag
            :type="detailObj.alarmTotal > 10 ? 'danger' : detailObj.alarmTotal > 5 ? 'warning' : 'primary'"
            size="small"
          >
            {{ detailObj.alarmTotal }}
          </el-tag>
        </div>
      </div>
      <div class="detail-card-row">
        ...
        <div class="detail-row-right">
          <el-tag
            :type="detailObj.faultDeviceCount > 3 ? 'danger' : detailObj.faultDeviceCount > 1 ? 'warning' : 'success'"
            size="small"
          >
            {{ detailObj.faultDeviceCount }}
          </el-tag>
        </div>
      </div>
      <div class="detail-card-row">
