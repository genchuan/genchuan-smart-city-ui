...
export function getColumns() {
  ...
  const columns = [
    ...
    { field: 'major', title: '意向专业', minWidth: 150, slots: { default: 'major' } },
    { field: 'applyTime', title: '报名时间', minWidth: 180, slots: { default: 'applyTime' } },
    { field: 'auditUser', title: '审核人', minWidth: 100 },
    { field: 'auditTime', title: '审核时间', minWidth: 180, slots: { default: 'auditTime' } },
    { field: 'confirmTime', title: '录取确认时间', minWidth: 180, slots: { default: 'confirmTime' } },
