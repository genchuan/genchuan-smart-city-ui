...
const drawerTitle = computed(() => {
  const roadSectionName = detailObj.value?.roadSectionName || '乱贴乱画';
    ...
    <div class="detail-card">
      ...
      <div class="detail-card-row">
        ...
        <div class="detail-row-right">
          {{ detailObj.facilityLocation || '-' }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">设施类型:</div>
        <div class="detail-row-right">
          {{ detailObj.facilityTypeId || '-' }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">乱贴数量:</div>
        <div class="detail-row-right">
          {{ detailObj.count || '-' }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">保洁责任区:</div>
        <div class="detail-row-right">
          {{ detailObj.cleanAreaCode || '-' }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">清理难度等级:</div>
        <div class="detail-row-right">
          {{ detailObj.cleanDifficultyId || '-' }}
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">保洁员:</div>
        <div class="detail-row-right">
          {{ detailObj.cleanerId || '-' }}
        </div>
      </div>
