...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row"><div class="detail-row-left">账号创建时间：</div><div class="detail-row-right">{{ formatTimestamp(detailObj.accountCreateTime) }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">账号状态：</div><div class="detail-row-right">{{ detailObj.accountStatus || '-' }}</div></div>
