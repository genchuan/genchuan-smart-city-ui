...
import { importInspectUser } from '#/api/genchuan/industry/chargePark/inspectOp/inspectMgmt/inspectUser';
...
function downloadTemplate() {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, '巡检人员导入模板');
...
async function handleImport() {
  ...
  try {
    const response = await importInspectUser(file);
