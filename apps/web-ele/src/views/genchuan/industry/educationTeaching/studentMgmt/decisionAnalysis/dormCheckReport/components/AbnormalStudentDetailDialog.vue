...
import {getAbnormalStudentDetailList} from '#/api/genchuan/industry/educationTeaching/studentMgmt/decisionAnalysis/dormCheckReport/data.js';
...
<template>
  <DetailDrawer title="考勤异常学生明细" class="genchuan-detail-drawer">
