...
import markerOverflow from '../../images/clear-overflow.png'; // 满溢
import markerWaitClear from '../../images/clear-wait.png'; // 待清运
import markerCleared from '../../images/clear-done.png'; // 已清运
import markerGray from '../../images/marker-gray.png'; // 默认
