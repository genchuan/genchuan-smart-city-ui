            ...
            resolve([
              {
                ...
                deviceId: 'DZ-350602-001',
                alertContent:
                  '芗城区新华西商业街停车场出口道闸完全卡死，无法升降，已造成10余辆车拥堵',
              ...
              },
              {
                ...
                deviceId: 'XJ-350603-002',
                alertContent:
                  '龙文区蓝田开发区停车场入口车牌识别相机离线，无法自动识别车牌',
              ...
              },
              {
                ...
                alertContent:
                  '龙海区石码镇锦江广场停车场B区计费系统出现金额计算错误，多收用户费用',
              ...
              },
              {
                ...
                alertContent:
                  '漳浦县绥安镇市民广场停车场充电桩泊位被车辆占用超8小时，未充电',
              ...
              },
              {
                ...
                alertContent:
                  '云霄县莆美镇万达广场停车场有多辆车尾随前车逃费离场，累计逃费金额超500元',
              ...
              },
              {
                ...
                deviceId: 'CGQ-350603-007',
                alertContent:
                  '龙文区吾悦广场停车场C区车位传感器批量离线，车位状态无法更新',
          ...
          setTimeout(() => {
            resolve([
              ...
              },
              {
                ...
                influenceRange:
                  '龙文区蓝田开发区停车场入口道闸设备老化，故障率达30%，覆盖8个泊位',
                rectificationRequirement:
                  '更换老化的道闸传动部件，完成设备全面检修',
                rectificationDeadline: '2025-01-10 18:00:00',
                responsibleUnit: '漳州市龙文区市政设施维护公司',
                responsiblePerson: '李四',
                rectificationMeasure:
                  '采购同型号传动部件，安排工程师上门更换，更换后进行72小时试运行',
              ...
              },
              {
                ...
                influenceRange:
                  '漳浦县绥安镇市民广场停车场收费系统存在金额计算漏洞，可能导致费用流失',
                rectificationRequirement:
                  '修复系统漏洞，完成数据对账，加强系统权限管理',
                rectificationDeadline: '2025-01-09 18:00:00',
                responsibleUnit: '漳州市漳浦县智慧停车运营公司',
                responsiblePerson: '赵六',
                rectificationMeasure:
                  '联系系统开发商修复计算漏洞，对近7天收费数据进行核查，新增系统操作日志审计',
              ...
              },
              {
                ...
                hiddenDangerType: '泊位标线模糊',
                influenceRange:
                  '云霄县莆美镇万达广场停车场C区15个泊位标线磨损，影响停车引导',
              ...
              },
              {
                ...
                hiddenDangerType: '消防通道占用隐患',
                influenceRange:
                  '芗城区江滨路停车场消防通道被杂物堆积，应急情况下无法快速通行',
                rectificationRequirement:
                  '立即清理杂物，设置消防通道警示标识，纳入日常巡检',
                rectificationDeadline: '2025-01-08 18:00:00',
                responsibleUnit: '漳州市芗城区停车场管理中心',
                responsiblePerson: '张三',
                rectificationMeasure:
                  '组织人员清理杂物，安装反光警示标识，将消防通道巡检纳入每日工作清单',
                rectificationStatus: '已完成',
            ...
            resolve([
              {
                ...
                complianceStandard:
                  '《福建省停车场管理条例》第18条，收费标准需公示并留存备案',
                rectificationRequirement:
                  '立即在停车场入口、出口显眼位置张贴收费公示牌，包含标准及投诉电话',
              ...
              },
              {
                ...
                complianceStandard:
                  '《消防法》第16条，停车场消防设施需定期检查并保持完好有效',
                rectificationRequirement:
                  '更换全部过期灭火器，补齐消防沙箱黄沙，建立消防设施月度巡检台账',
              ...
              },
              {
                ...
                complianceStandard:
                  '《城市道路管理条例》第27条，严禁擅自占用道路设置停车泊位',
                rectificationRequirement:
                  '立即拆除违规增设泊位标线及地锁，恢复非机动车道正常通行',
              ...
              },
              {
                ...
                complianceStandard:
                  '《税收征收管理法》第21条，经营收费需开具合规票据，严禁私收款项',
                rectificationRequirement:
                  '对涉事收费员停岗培训，补开用户发票，安装收费监督摄像头',
              ...
              },
              {
                ...
                complianceStandard:
                  '《电动汽车充电基础设施运营管理规范》第9条，充电区域需配备安全防护设施',
                rectificationRequirement:
                  '铺设绝缘防滑垫，张贴高压危险警示标识，加装应急断电开关',
              ...
              },
              {
                ...
                complianceStandard:
                  '《机械式停车设备安全规范》第7条，道闸需加装防砸及感应装置',
                rectificationRequirement:
                  '为所有道闸加装防砸雷达及红外感应，完成安全调试后投入使用',
              ...
              },
              {
                ...
                complianceStandard:
                  '《漳州智慧停车管理办法》第23条，运营单位需每月5日前上报相关台账',
                rectificationRequirement:
                  '补报往期缺失台账，安排专人负责月度数据上报工作',
            ...
            resolve([
              {
                ...
                alertContent:
                  '芗城区新华西商业街停车场VIP泊位被普通车辆占用超12小时，车主拒不配合挪车',
                occurTime: '2025-01-08 08:20:00',
                disposalStatus: '处置中',
                disposalMeasure:
                  '联系交警部门协助挪车，张贴泊位专属标识，加装地锁管控',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108001.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '龙文区蓝田开发区停车场车位传感器单日离线超10次，数据上传中断，影响车位引导',
                occurTime: '2025-01-08 09:30:00',
                disposalStatus: '未处置',
                disposalMeasure:
                  '检查传感器网络线路，更换故障天线，升级设备固件版本',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108002.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '龙海区石码镇锦江广场停车场微信支付通道崩溃，车主无法扫码缴费，造成出口拥堵',
                occurTime: '2025-01-08 11:10:00',
                disposalStatus: '已办结',
                disposalMeasure:
                  '紧急切换备用支付通道，联系支付服务商修复接口，增派人工收费窗口',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108003.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '漳浦县绥安镇市民广场停车场配电房区域有无关人员闯入，触碰高压设备，存在触电风险',
                occurTime: '2025-01-08 14:20:00',
                disposalStatus: '处置中',
                disposalMeasure:
                  '现场驱离无关人员，加装防爬护栏及警示灯带，增设24小时安保巡逻岗',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108004.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '云霄县莆美镇万达广场停车场出口道闸防砸雷达故障，砸中通行车辆，造成车辆剐蹭',
                occurTime: '2025-01-08 07:40:00',
                disposalStatus: '超时',
                disposalMeasure:
                  '更换故障防砸雷达，调试红外感应装置，对车主进行赔偿协商，整改安全隐患',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108005.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '芗城区江滨路停车场新能源车位标线严重磨损，车主无法识别，燃油车占用充电泊位',
                occurTime: '2025-01-08 15:50:00',
                disposalStatus: '未处置',
                disposalMeasure:
                  '重新喷涂新能源车位专属彩色标线，加装车位识别指示牌，安排人员现场引导',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108006.mp4',
              ...
              },
              {
                ...
                alertContent:
                  '龙文区吾悦广场停车场消防通道被私家车堵塞，消防门无法正常开启，存在消防安全隐患',
                occurTime: '2025-01-08 12:30:00',
                disposalStatus: '已办结',
                disposalMeasure:
                  '联系车主挪车，加装消防通道禁停桩，张贴违法占用处罚公示，联动消防部门巡检',
                videoUrl:
                  'https://video.zhangzhou-parking.com/ZX20250108007.mp4',
...
export const fetchAbnormalWarningDurationSummary = (params = {}) => {
  try {
    ...
    console.error(
      '===== fetchAbnormalWarningDurationSummary 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
    return Promise.resolve({
...
export const fetchDisposalProgressDurationSummary = (params = {}) => {
  try {
    ...
    console.error(
      '===== fetchDisposalProgressDurationSummary 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
    return Promise.resolve({
...
export const fetchDisposalProgressTrackingList = (params = {}) => {
  try {
            ...
            resolve([
              {
                ...
                maintainUserId: 'WX001',
                disposalMeasure:
                  '更换道闸控制主板及传动齿轮，调试升降限位功能，现场测试运行正常',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108001.pdf',
                updateTime: '2025-01-08 12:15:00',
              },
              {
                alertId: 'DP20250108002',
                alertContent:
                  '龙文区蓝田开发区停车场车牌识别相机离线，无法自动抬杆通行',
                occurTime: '2025-01-08 10:10:00',
                ...
                maintainUserId: 'WX002',
                disposalMeasure:
                  '重新插拔相机网络线路，升级识别算法固件，测试车牌识别准确率达99.8%',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108002.pdf',
                updateTime: '2025-01-08 14:58:00',
              },
              {
                alertId: 'DP20250108003',
                alertContent:
                  '龙海区石码镇锦江广场计费系统金额计算错误，多收取用户停车费用',
                occurTime: '2025-01-08 11:20:00',
                ...
                maintainUserId: 'WX003',
                disposalMeasure:
                  '修复计费系统计算公式漏洞，对多收费用进行原路退还，核查近7天计费数据',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108003.pdf',
                updateTime: '2025-01-08 13:19:00',
              },
              {
                alertId: 'DP20250108004',
                alertContent:
                  '漳浦县绥安镇充电桩泊位被燃油车占用超8小时，新能源车主无法充电',
                occurTime: '2025-01-08 14:00:00',
                ...
                maintainUserId: 'WX004',
                disposalMeasure:
                  '联系车主挪车，加装新能源车位地锁，张贴禁停标识，安排现场人员引导',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108004.pdf',
                updateTime: '2025-01-08 20:55:00',
              },
              {
                alertId: 'DP20250108005',
                alertContent:
                  '云霄县万达广场多辆车尾随前车逃费离场，累计逃费金额超500元',
                occurTime: '2025-01-08 07:50:00',
                ...
                maintainUserId: 'WX005',
                disposalMeasure:
                  '待指派运维人员现场核实，加装防逃费识别摄像头，联动保安现场值守',
                disposalResult: '处置中',
                attachmentUrl: '',
              ...
              },
              {
                ...
                maintainUserId: 'WX001',
                disposalMeasure:
                  '检修消防水泵增压系统，更换老化消防水管，补水加压后测试水压达标',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108006.pdf',
                updateTime: '2025-01-08 18:29:00',
              },
              {
                alertId: 'DP20250108007',
                alertContent:
                  '龙文区吾悦广场车位传感器批量离线，车位状态显示错误引导失效',
                occurTime: '2025-01-08 12:10:00',
                ...
                maintainUserId: 'WX003',
                disposalMeasure:
                  '更换故障传感器电池及信号模块，重新组网调试，车位数据准确率恢复正常',
                disposalResult: '处置成功',
                attachmentUrl:
                  'https://file.zhangzhou-parking.com/attachment/DP20250108007.pdf',
    ...
    console.error(
      '===== fetchDisposalProgressTrackingList 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
    return Promise.resolve([]);
            ...
            resolve([
              {
                ...
                abnormalType: '数据异常',
                abnormalReason:
                  '泊位传感器数据上传延迟，车位占用状态与实际不符，数据同步超时',
                influenceRange:
                  '芗城区新华西商业街停车场25个泊位数据异常，覆盖3个出入口',
                relieveTime: '2025-01-08 10:30:00',
                relieveReason:
                  '重启数据采集网关，修复网络传输卡顿问题，重新校准传感器数据',
                areaCode: '350602',
                lotId: 'ZZXC001',
                createTime: '2025-01-08 09:15:00',
              },
              {
                ...
                abnormalType: '收费异常',
                abnormalReason:
                  '停车计费系统费率配置错误，夜间停车费用翻倍计算，导致用户投诉',
                influenceRange:
                  '龙文区蓝田开发区停车场全场42个泊位计费异常，涉及用户68人',
                relieveTime: '2025-01-08 11:45:00',
                relieveReason:
                  '修正计费系统费率模板，对多收费用原路退还，重启计费服务生效',
                areaCode: '350603',
                lotId: 'ZZLW002',
              ...
              },
              {
                ...
                abnormalType: '诱导信息异常',
                abnormalReason:
                  '车位诱导屏显示数据错误，空余车位数量与实际偏差过大，误导车主停车',
                influenceRange:
                  '龙海区石码镇锦江广场停车场B区30个泊位诱导异常，覆盖2个诱导屏',
                relieveTime: '2025-01-08 13:20:00',
                relieveReason:
                  '重新同步车位数据至诱导屏，校准显示参数，升级诱导系统固件版本',
                areaCode: '350604',
                lotId: 'ZZLH003',
              ...
              },
              {
                ...
                abnormalType: '流程异常',
                abnormalReason:
                  '停车离场审核流程卡顿，车主缴费后无法自动抬杆，需人工干预放行',
                influenceRange:
                  '漳浦县绥安镇市民广场停车场出口2个道闸，日均影响离场车辆120辆',
                relieveTime: '2025-01-08 15:50:00',
                relieveReason:
                  '优化离场审核接口逻辑，清理系统缓存，修复流程阻塞BUG',
                areaCode: '350623',
                lotId: 'ZZZP004',
              ...
              },
              {
                ...
                abnormalType: '数据异常',
                abnormalReason:
                  '充电桩功率数据采集失败，充电量统计不准，无法生成充电明细账单',
                influenceRange:
                  '云霄县莆美镇万达广场停车场6个充电桩泊位，涉及新能源车主35人',
                relieveTime: '',
                relieveReason: '',
                areaCode: '350622',
                lotId: 'ZZYX005',
              ...
              },
              {
                ...
                abnormalType: '收费异常',
                abnormalReason:
                  '扫码支付通道对接超时，车主付款后订单状态未同步，显示未缴费',
                influenceRange:
                  '芗城区江滨路停车场入口1个收费岗亭，出口2个自助缴费机',
                relieveTime: '2025-01-08 16:10:00',
                relieveReason:
                  '切换备用支付通道，联系支付服务商修复接口，手动同步未完成订单状态',
                areaCode: '350602',
                lotId: 'ZZXC006',
              ...
              },
              {
                ...
                abnormalType: '流程异常',
                abnormalReason:
                  '泊位预约审核流程失效，预约车位被占用，预约用户无法正常停车',
                influenceRange:
                  '龙文区吾悦广场停车场10个预约专属泊位，日均影响预约用户20人',
                relieveTime: '',
                relieveReason: '',
                areaCode: '350603',
                lotId: 'ZZLW007',
