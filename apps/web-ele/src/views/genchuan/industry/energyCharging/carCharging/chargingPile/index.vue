<script setup>
import { ref } from 'vue';
import chargingPileChart from './chargingPileChart.vue';
...
<template>
  <div class="common-index">
    <chargingPileChart v-if="tabArray[0].arrowShow" />
...
.common-index {
  .common-tabs {
    :deep(.el-tabs__nav) { margin-left: 0px !important; }
    :deep(.el-tabs__item) { padding-right: 5px !important; }
  }
}
</style>
