<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="阈值类型(上限/下限)" label-width="auto" prop="thresholdType">
        <el-input
      ...
      <el-form-item label="适用场景(如管网末梢)" label-width="auto" prop="applicableScene">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:warning-threshold:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:warning-threshold:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="阈值类型(上限/下限)" align="center" prop="thresholdType" />
      <el-table-column label="阈值数值" align="center" prop="thresholdValue" />
      <el-table-column label="单位" align="center" prop="unit" />
      <el-table-column label="适用场景(如管网末梢)" align="center" prop="applicableScene" />
      <el-table-column
        label="生效时间"
        align="center"
        prop="effectiveTime"
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['waterdetection:warning-threshold:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['waterdetection:warning-threshold:delete']"
          >
            删除
          </el-button>
        </template>
...
const list = ref<WarningThresholdVO[]>([]) // 列表的数据
