...
export const EnforcementPublicityApi = {
  ...
  getEnforcementPublicityPage: async (params: any) => {
    return await requestClient.get(`/smartcity/enforcement-publicity/page`, {
      params,
    });
  },
  ...
  getEnforcementPublicity: async (id: number) => {
    return await requestClient.get(`/smartcity/enforcement-publicity/get`, {
      params: { id },
    });
  },
  ...
  createEnforcementPublicity: async (data: any) => {
    return await requestClient.post(
      `/smartcity/enforcement-publicity/create`,
      data,
    );
  },
  ...
  updateEnforcementPublicity: async (data: any) => {
    return await requestClient.put(
      `/smartcity/enforcement-publicity/update`,
      data,
    );
  },
  ...
  deleteEnforcementPublicity: async (id: number) => {
    return await requestClient.delete(
      `/smartcity/enforcement-publicity/delete`,
      { params: { id } },
    );
  },
  ...
  exportEnforcementPublicity: async (params) => {
    return await requestClient.download(
      `/smartcity/enforcement-publicity/export-excel`,
      params,
    );
  },
};
