...
export function useGridColumns() {
  return [
    ...
    { field: 'leaveTotal', title: '离校总人数', minWidth: 130, sortable: true, slots: { default: 'leaveTotal' } },
    { field: 'handleFinishRate', title: '办理完成率(%)', minWidth: 150, sortable: true },
    { field: 'checkoutFinishRate', title: '退宿完成率(%)', minWidth: 150, sortable: true },
    { field: 'parentConfirmRate', title: '家长确认率(%)', minWidth: 150, sortable: true },
    ...
    { field: 'leaveTotalYoy', title: '离校人数同比(%)', minWidth: 150, sortable: true },
    { field: 'leaveTotalQoq', title: '离校人数环比(%)', minWidth: 150, sortable: true },
...
export const detailFields = [
  ...
  { key: 'leaveTotal', label: '离校总人数' },
  { key: 'handleFinishRate', label: '办理完成率(%)' },
  { key: 'checkoutFinishRate', label: '退宿完成率(%)' },
  { key: 'parentConfirmRate', label: '家长确认率(%)' },
  ...
  { key: 'leaveTotalYoy', label: '离校人数同比(%)' },
  { key: 'leaveTotalQoq', label: '离校人数环比(%)' },
