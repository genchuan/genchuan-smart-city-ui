...
import { CaseInvestigationApi } from '#/api/genchuan/shunchangOpsService/smartcity/list/commandCoordination/lawenforcement/lawEnforcementCaseHandling/caseinvestigation';
  ...
  if (id) {
    ...
    try {
      ...
      formData.value = {
        ...res,
        // 将字符串时间戳转为数字
        investigationStartTime: res.investigationStartTime
          ? Number(res.investigationStartTime)
          : undefined,
        investigationEndTime: res.investigationEndTime
          ? Number(res.investigationEndTime)
          : undefined,
      };
    } finally {
  ...
  >
    ...
    >
      ...
      <ElFormItem label="调查负责人" prop="investigationLeader">
        <ElInput
          v-model="formData.investigationLeader"
          placeholder="请输入调查负责人"
        />
      </ElFormItem>
      <ElFormItem label="调查组成员" prop="investigationTeam">
        <ElInput
          v-model="formData.investigationTeam"
          placeholder="请输入调查组成员"
        />
      </ElFormItem>
      ...
      <ElFormItem label="现场勘查情况" prop="investigationDesc">
        <ElInput
          v-model="formData.investigationDesc"
          placeholder="请输入现场勘查情况"
        />
      </ElFormItem>
      <ElFormItem label="证据情况描述" prop="evidenceDesc">
        <ElInput
          v-model="formData.evidenceDesc"
          placeholder="请输入证据情况描述"
        />
      </ElFormItem>
      <ElFormItem label="证人证言描述" prop="testimonyDesc">
        <ElInput
          v-model="formData.testimonyDesc"
          placeholder="请输入证人证言描述"
        />
      </ElFormItem>
