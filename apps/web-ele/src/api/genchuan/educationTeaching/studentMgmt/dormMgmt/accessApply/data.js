...
export function getAccessApplyPage(params) {
  ...
  return requestClient
    .get('/studentmgmt/access-apply/page', { params: convertedParams })
    .then((res) => {
      if (res && res.list) {
...
export function createAccessApply(data) {
  ...
  return requestClient
    .post('/studentmgmt/access-apply/create', convertedData)
    .catch((error) => {
...
export function auditAccessApply(data) {
  // 审核接口只传 ids，无需转换
  return requestClient
    .put('/studentmgmt/access-apply/audit', data)
    .catch((error) => {
...
export function updateAccessApply(data) {
  const convertedData = convertZhToEn(data);
  return requestClient
    .put('/studentmgmt/access-apply/update', convertedData)
    .catch((error) => {
...
export function exportAccessApply(params) {
  const convertedParams = convertZhToEn(params);
  return requestClient
    .download('/studentmgmt/access-apply/export-excel', convertedParams)
    .catch((error) => {
...
export function getAccessApplyDetail(params) {
  return requestClient
    .get('/studentmgmt/access-apply/get', { params })
...
export function getAccessApplyChart(params) {
  const convertedParams = convertZhToEn(params);
  return requestClient
    .get('/studentmgmt/access-apply/chart', { params: convertedParams })
    .catch((error) => {
...
export function getAccessApplyCount(params) {
  const convertedParams = convertZhToEn(params);
  return requestClient
    .get('/studentmgmt/access-apply/applyCount', { params: convertedParams })
    .catch((error) => {
      console.warn('班级统计接口失败，使用模拟数据', error);
      return {
        classStatistics: [
          {
            className: '高一1班',
