...
import { ElCol, ElFormItem, ElOption, ElRow, ElSelect, ElTag } from 'element-plus';
...
<template>
  <div class="device-control-config">
    ...
    <!-- 服务选择 - 服务调用类型时显示 -->
    <div v-if="action.productId && isServiceInvokeAction" class="service-section">
      ...
      <!-- 服务参数配置 -->
      <div v-if="action.identifier" class="service-params">
    ...
    <!-- 控制参数配置 - 属性设置类型时显示 -->
    <div v-if="action.productId && isPropertySetAction" class="property-section">
