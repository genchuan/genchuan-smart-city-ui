...
export const DrainageUserApi = {
  ...
  getDrainageUser: async (id: number) => {
    return await requestClient.get(`/smartcity/drainage-user/get`, {
      params: { id },
    });
  },
  ...
  deleteDrainageUser: async (id: number) => {
    return await requestClient.delete(`/smartcity/drainage-user/delete`, {
      params: { id },
    });
  },
  ...
  exportDrainageUser: async (params) => {
    return await requestClient.download(
      `/smartcity/drainage-user/export-excel`,
      params,
    );
  },
};
