<template>
  <div class="chart-type-line" :style="{ height: height }">
    <div
      class="chart-type-line-left chart-type-line-left2"
      :id="idName"
            ...
            colorStops: [
              {
                offset: 0, // 0%处的颜色
                color:
                  props.seriesData[i].color.length > 0
                    ? props.seriesData[i].color[0]
                    : '#02a8f1',
              },
              {
                offset: 1, // 100%处的颜色
                color:
                  props.seriesData[i].color.length > 1
                    ? props.seriesData[i].color[1]
                    : '#0c1e65',
              },
            ],
          },
