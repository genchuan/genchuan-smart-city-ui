...
export const fetchLawGlobalOverview = async (params = {}) => {
  ...
  // try {
  //   const response = await requestClient.get({ url: `${BASE_URL}/law-overview/get`, params });
...
//
//   try {
//     const response = await .get({ url: `${BASE_URL}/law-core-metrics/get`, params });
//     if (response ) {
...
export const fetchRealTimeLocations = async () => {
  ...
  // try {
  //   const response = await requestClient.get({ url: `${BASE_URL}/realTimeLocations` });
...
export const filterCases = async (filters) => {
  ...
  // try {
  //   const response = await requestClient.post({ url: `${BASE_URL}/cases/filter`, data: filters });
...
export const fetchCaseDetail = async (caseId) => {
  ...
  // try {
  //   const response = await requestClient.get({ url: `${BASE_URL}/case/${caseId}` });
...
export const viewReport = async (reportId) => {
  ...
  // try {
  //   const response = await requestClient.get({ url: `${BASE_URL}/report/${reportId}` });
...
export const updateIndicatorReason = async (params) => {
  ...
  try {
    const response = await requestClient.post({ url: `${BASE_URL}/indicator/reason`, data: params });
...
export const updateIndicatorThreshold = async (params) => {
  ...
  try {
    const response = await requestClient.post({ url: `${BASE_URL}/indicator/threshold`, data: params });
...
export const handleWarning = async (params) => {
  ...
  try {
    const response = await requestClient.post({ url: `${BASE_URL}/warning/handle`, data: params });
...
export const submitServiceHandle = async (params) => {
  ...
  try {
    const response = await requestClient.post({ url: `${BASE_URL}/service/handle`, data: params });
