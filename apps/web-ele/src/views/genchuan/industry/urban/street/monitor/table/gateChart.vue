...
const state = reactive({
  ...
  mapData: [
    ...
    {
      id: 4,
      locationName: '漳州路段路灯1',
      coordinateInfo: '117.6393,24.5000',
      statusName: '正常',
      riskLevel: '低风险',
    },
    {
      id: 5,
      locationName: '莆田路段路灯1',
    ...
    {
      id: 10,
      locationName: '平潭路段路灯1',
      coordinateInfo: '119.7013,25.5337',
      statusName: '正常',
      riskLevel: '低风险',
    },
  ],
