  ...
  <div class="page-container" ref="pageContainerRef">
    ...
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <el-button size="small" @click="clickFullscreen">全屏</el-button>
      </div>
    </div>
...
} from '#/api/genchuan/industry/culturesportstourism/SubdomainScenarioTopics.js';
...
const initData = async () => {
  ...
  // 2. 获取类型分布数据
  typeDistributionData.value = await fetchResourceTypeDistribution();

  // 3. 获取状态分布数据
  statusDistributionData.value = await fetchResourceStatusDistribution();

  // 4. 获取闲置资源列表
  idleResources.value = await fetchIdleResourceList();
};
