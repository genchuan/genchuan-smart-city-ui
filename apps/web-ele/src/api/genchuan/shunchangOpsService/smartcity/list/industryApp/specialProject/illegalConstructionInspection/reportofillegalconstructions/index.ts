...
export const ReportOfIllegalConstructionsApi = {
  ...
  getReportOfIllegalConstructionsPage: async (params: any) => {
    return await requestClient.get(`/smartcity/report-of-illegal-constructions/page`, { params });
  },

  // 查询违建上报详情
  getReportOfIllegalConstructions: async (id: number) => {
    return await requestClient.get(`/smartcity/report-of-illegal-constructions/get`, { params: { id } });
  },

  // 新增违建上报
  createReportOfIllegalConstructions: async (data: any) => {
    return await requestClient.post(`/smartcity/report-of-illegal-constructions/create`, data);
  },

  // 修改违建上报
  updateReportOfIllegalConstructions: async (data: any) => {
    return await requestClient.put(`/smartcity/report-of-illegal-constructions/update`, data);
  },

  // 删除违建上报
  deleteReportOfIllegalConstructions: async (id: number) => {
    return await requestClient.delete(`/smartcity/report-of-illegal-constructions/delete`, { params: { id } });
  },

  // 导出违建上报 Excel
  exportReportOfIllegalConstructions: async (params) => {
    return await requestClient.download(`/smartcity/report-of-illegal-constructions/export-excel`, params);
  },
};
