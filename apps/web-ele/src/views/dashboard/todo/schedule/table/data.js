  ...
  return [
    {
      ...
      "location": "A区数据中心-主控室",
      "coWorkers": "张三,李四",
      "dutyRequirement": "1. 每小时巡查机房温湿度；2. 监控服务器状态；3. 处理紧急告警；4. 填写值班日志",
      "scheduleStatus": "正常",
      "handoverStatus": "已交接",
    ...
    },
    {
      ...
      "location": "A区数据中心-主控室",
      "coWorkers": "李四,王五",
      "dutyRequirement": "1. 夜间巡检每2小时一次；2. 监控备份任务；3. 应急响应准备；4. 填写夜间值班记录",
      "scheduleStatus": "换班中",
      "handoverStatus": "未交接",
      "handoverTime": "",
      "receiver": "",
    ...
    },
    {
      ...
      "location": "B区网络中心",
      "coWorkers": "赵六,孙七",
      "dutyRequirement": "1. 监控网络流量；2. 处理网络告警；3. 更新网络配置；4. 编写网络日报",
      "scheduleStatus": "已换班",
      "handoverStatus": "已交接",
    ...
    },
    {
      ...
      "location": "C区安全中心",
      "coWorkers": "钱十,郑十一",
      "dutyRequirement": "1. 监控安全事件；2. 分析安全日志；3. 应急响应；4. 编写安全日报",
      "scheduleStatus": "换班中",
      "handoverStatus": "已交接",
    ...
    case 'mySchedule': // 我的排班
      return [
        ...
        },
        {
          ...
          title: '同岗人员',
          minWidth: 150,
          formatter: ({ cellValue }) => cellValue ? (cellValue.length > 20 ? cellValue.substring(0, 20) + '...' : cellValue) : '-',
    ...
    case 'shiftApply': // 换班申请
      return [
        ...baseColumns,
        {
          ...
          title: '原值班信息',
          minWidth: 200,
          formatter: ({ row }) => row.scheduleDate && row.shiftTime ? `${row.scheduleDate} ${row.shiftTime}` : '-',
        },
        {
