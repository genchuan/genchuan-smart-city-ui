        ...
        <div class="top_right" style="min-width: 3vw;">
          ...
          <div class="park-overview-panel panel">
            <div class="panel-header">
              <p></p>
              <div class="header-actions">
                <el-radio-group v-model="parkNameFilter" placeholder="选择园区" size="small">
                  <el-radio style="color: lightblue;" label="高新技术产业园区" value="高新技术产业园区" />
                  <el-radio style="color: lightblue;" label="经济开发区" value="经济开发区" />
                  <el-radio style="color: lightblue;" label="物流园区" value="物流园区" />
                </el-radio-group>
              </div>
            </div>
            <div class="panel-body">
        ...
        <div class="bottom_right" style="min-width: 2vw;" ref="list">
          ...
          <div class="panel" style="width: 100%; height: 100%">
            <div class="panel-header">
              <h2>园区基础信息列表</h2>
              <div class="header-actions">
                <el-radio-group v-model="parkLevelFilter" placeholder="园区等级" size="small">
                  <el-radio style="color: lightblue;" label="全部" value="" />
                  <el-radio style="color: lightblue;" label="国家级" value="国家级" />
                  <el-radio style="color: lightblue;" label="省级" value="省级" />
                  <el-radio style="color: lightblue;" label="市级" value="市级" />
                </el-radio-group>
...
} from '#/api/genchuan/industry/industrialpark/overview/GlobalSituationOverview.js';
