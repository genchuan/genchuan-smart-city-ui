...
} from '#/api/genchuan/educationTeaching/studentMgmt/homeSchool/parentReply/data.js';
import {
  textObj,
  useFormSchema,
  getColumns,
  useReplyFormSchema,
} from '#/api/genchuan/educationTeaching/studentMgmt/homeSchool/parentReply/form.js';
