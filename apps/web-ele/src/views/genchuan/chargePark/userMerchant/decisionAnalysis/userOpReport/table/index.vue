...
import type { UserOpReportDetailVO } from '#/api/genchuan/chargePark/userMerchant/decisionAnalysis/userOpReport';
...
import { UserOpReportApi } from '#/api/genchuan/chargePark/userMerchant/decisionAnalysis/userOpReport';
