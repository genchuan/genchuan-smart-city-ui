...
import type { MerchantInfoRow } from './data';
...
import { buildAuditLogs, buildStatsData, getMockMerchants } from './data';
...
const merchants = ref<MerchantInfoRow[]>(
  getMockMerchants().map((item) => ({
    ...item,
...
const statsData = computed(() => {
  const data = buildStatsData(merchants.value);
