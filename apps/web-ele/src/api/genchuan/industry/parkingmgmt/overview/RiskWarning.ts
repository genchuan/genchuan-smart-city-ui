        ...
        if (response && Array.isArray(response)) {
          ...
          return response.map((item) => ({
            ...
            parkMaintainWorkorderWorkorderNo:
              item.parkMaintainWorkorderWorkorderNo,
            ...
            resolve([
              {
                ...
                parkAlarmAlarmTime: 1_737_283_200_000,
                ...
                parkAlarmReceiveTime: 1_737_283_500_000,
              ...
              },
              {
                ...
                parkAlarmDisposalLog: [
                  {
                    time: 1_737_281_000_000,
                    content: '已派单至消防维保，预计1小时到场处理',
                  },
                ],
              ...
              },
              {
                ...
                parkAlarmAlarmTime: 1_737_276_000_000,
                ...
                parkAlarmReceiveTime: 1_737_276_200_000,
                ...
                parkAlarmDisposalLog: [
                  {
                    time: 1_737_277_000_000,
                    content: '已驱离违规车辆，清理应急通道',
                  },
                ],
              ...
              },
              {
                ...
                parkAlarmAlarmTime: 1_737_272_400_000,
                ...
                parkAlarmReceiveTime: 1_737_272_600_000,
                ...
                parkAlarmDisposalLog: [
                  {
                    time: 1_737_273_000_000,
                    content: '核实为用户操作失误，重新缴费完成，驳回预警',
                  },
                ],
              ...
              },
              {
                ...
                parkAlarmDisposalLog: [
                  {
                    time: 1_737_262_500_000,
                    content: '安保人员到场核实，联系车主移车',
                  },
                ],
              ...
              },
              {
                ...
                parkAlarmDisposalLog: [
                  {
                    time: 1_737_255_000_000,
                    content: '门禁系统重启后恢复正常，测试无异常',
                  },
                ],
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              parkMaintainWorkorderWorkorderNo: `W${Date.now()}`, // 自动生成工单编号
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            ...
            resolve({
              ...
              workorderAssignTime: 1_737_281_000_000, // 工单派单时间
              workorderHandler: '漳州智慧停车运维中心-张三', // 工单处理人
              feedbackResult:
                '维保人员预计15分钟后到达现场，已联系现场安保人员协助', // 反馈结果
              parkAlarmDisposalLog: [
                {
                  time: 1_737_281_000_000,
                  content: '已派单至消防维保，预计1小时到场处理',
                ...
                {
                  time: 1_737_282_000_000,
                  content: '维保人员已出发，当前位置：龙江大道中段',
                },
              ],
            });
          }, 500);
      ...
      .then((response) => {
        if (response && Array.isArray(response)) {
          return response.map((item) => ({
            ...
            parkMaintainWorkorderWorkorderNo:
              item.parkMaintainWorkorderWorkorderNo,
            parkMaintainWorkorderExpectedFinishTime:
              item.parkMaintainWorkorderExpectedFinishTime,
            parkMaintainWorkorderLatestDynamic:
              item.parkMaintainWorkorderLatestDynamic,
            parkMaintainWorkorderDispatchDuration:
              item.parkMaintainWorkorderDispatchDuration,
            ...
            resolve([
              {
                ...
                parkMaintainWorkorderStartTime: 1_737_283_500_000,
                sysDisposalProgressName: '待派单',
                parkMaintainWorkorderWorkorderNo: 'W20260119001',
                parkMaintainWorkorderExpectedFinishTime: 1_737_290_700_000,
                parkMaintainWorkorderLatestDynamic:
                  '系统已生成工单，等待派单分配',
              ...
              },
              {
                ...
                parkMaintainWorkorderStartTime: 1_737_280_000_000,
                sysDisposalProgressName: '处理中',
                parkMaintainWorkorderWorkorderNo: 'W20260119002',
                parkMaintainWorkorderExpectedFinishTime: 1_737_287_200_000,
                parkMaintainWorkorderLatestDynamic:
                  '维保人员已到场，正在检修消防栓水压问题',
                ...
                disposeAllLog: [
                  { time: 1_737_280_000_000, content: '派单至消防维保李四' },
                  { time: 1_737_281_000_000, content: '维保人员出发' },
                  { time: 1_737_283_000_000, content: '到达现场开始检修' },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260119003',
                ...
                parkMaintainWorkorderStartTime: 1_737_276_200_000,
                sysDisposalProgressName: '已完成',
                parkMaintainWorkorderWorkorderNo: 'W20260119003',
                parkMaintainWorkorderExpectedFinishTime: 1_737_279_800_000,
                parkMaintainWorkorderLatestDynamic:
                  '违规车辆已驱离，应急通道恢复畅通，复核通过',
                ...
                disposeAllLog: [
                  { time: 1_737_276_200_000, content: '派单至城管王五' },
                  { time: 1_737_277_000_000, content: '驱离违规车辆' },
                  { time: 1_737_277_500_000, content: '处置完成复核通过' },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260119004',
                ...
                parkMaintainWorkorderStartTime: 1_737_272_600_000,
                sysDisposalProgressName: '已驳回',
                parkMaintainWorkorderWorkorderNo: 'W20260119004',
                parkMaintainWorkorderExpectedFinishTime: 1_737_275_000_000,
                parkMaintainWorkorderLatestDynamic:
                  '核实为用户操作失误，重新缴费完成，预警核销',
                ...
                disposeAllLog: [
                  { time: 1_737_272_600_000, content: '派单至收费管理赵六' },
                  {
                    time: 1_737_273_000_000,
                    content: '核实用户操作失误，驳回预警',
                  },
                ],
              },
              {
                ...
                parkMaintainWorkorderStartTime: 1_737_269_000_000,
                sysDisposalProgressName: '超时处置',
                parkMaintainWorkorderWorkorderNo: 'W20260119005',
                parkMaintainWorkorderExpectedFinishTime: 1_737_272_600_000,
                parkMaintainWorkorderLatestDynamic:
                  '工单超期未处理，已触发催办提醒',
                ...
                disposeAllLog: [
                  { time: 1_737_269_000_000, content: '工单生成' },
                  {
                    time: 1_737_272_600_000,
                    content: '工单超时，系统自动催办',
                  },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260120006',
                sysAlarmTypeName: '道闸卡死故障',
                sysMaintainUserUserName: '陈八-车场运维',
                parkMaintainWorkorderStartTime: 1_737_265_400_000,
                sysDisposalProgressName: '待派单',
                parkMaintainWorkorderWorkorderNo: 'W20260120006',
                parkMaintainWorkorderExpectedFinishTime: 1_737_269_000_000,
                parkMaintainWorkorderLatestDynamic:
                  '漳州芗城瑞京路停车场出口道闸卡死，车辆无法离场，等待派单处理',
                parkMaintainWorkorderDispatchDuration: 0.4,
                parkMaintainWorkorderDealTime: 0,
                parkAlarmEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                disposeAllLog: [
                  {
                    time: 1_737_265_400_000,
                    content: '漳州芗城区车场上报道闸故障，生成运维工单',
                  },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260120007',
                sysAlarmTypeName: '充电桩断电',
                sysMaintainUserUserName: '林九-电力维保',
                parkMaintainWorkorderStartTime: 1_737_261_800_000,
                sysDisposalProgressName: '处理中',
                parkMaintainWorkorderWorkorderNo: 'W20260120007',
                parkMaintainWorkorderExpectedFinishTime: 1_737_265_400_000,
                parkMaintainWorkorderLatestDynamic:
                  '漳州龙文区万达广场充电站3号充电桩无供电，运维人员已到场检测线路故障',
                parkMaintainWorkorderDispatchDuration: 0.3,
                parkMaintainWorkorderDealTime: 1.8,
                parkAlarmEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                disposeAllLog: [
                  {
                    time: 1_737_261_800_000,
                    content: '派单至漳州龙文电力维保林九',
                  },
                  { time: 1_737_262_400_000, content: '携带工具出发至充电站' },
                  {
                    time: 1_737_263_000_000,
                    content: '到达现场，开始检测充电桩线路',
                  },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260120008',
                sysAlarmTypeName: '摊贩占道经营',
                sysMaintainUserUserName: '黄十-秩序管理',
                parkMaintainWorkorderStartTime: 1_737_258_200_000,
                sysDisposalProgressName: '已完成',
                parkMaintainWorkorderWorkorderNo: 'W20260120008',
                parkMaintainWorkorderExpectedFinishTime: 1_737_261_800_000,
                parkMaintainWorkorderLatestDynamic:
                  '漳州台商投资区角美停车场入口摊贩占道，已清理完毕，车辆通行恢复正常',
                parkMaintainWorkorderDispatchDuration: 0.2,
                parkMaintainWorkorderDealTime: 0.9,
                parkAlarmEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                disposeAllLog: [
                  {
                    time: 1_737_258_200_000,
                    content: '派单至漳州台商区秩序管理黄十',
                  },
                  { time: 1_737_258_800_000, content: '到场劝离占道摊贩' },
                  {
                    time: 1_737_259_300_000,
                    content: '清理占道物品，复核通过完成处置',
                  },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260120009',
                sysAlarmTypeName: '车位锁故障',
                sysMaintainUserUserName: '吴十一-设备维保',
                parkMaintainWorkorderStartTime: 1_737_254_600_000,
                sysDisposalProgressName: '已驳回',
                parkMaintainWorkorderWorkorderNo: 'W20260120009',
                parkMaintainWorkorderExpectedFinishTime: 1_737_258_200_000,
                parkMaintainWorkorderLatestDynamic:
                  '漳州开发区双鱼岛停车场车位锁无法抬起，核实为车主误触应急锁，自行解锁完成，驳回报修工单',
                parkMaintainWorkorderDispatchDuration: 0.1,
                parkMaintainWorkorderDealTime: 0.5,
                parkAlarmEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                disposeAllLog: [
                  {
                    time: 1_737_254_600_000,
                    content: '派单至漳州开发区设备维保吴十一',
                  },
                  {
                    time: 1_737_255_000_000,
                    content: '远程指导车主解锁应急锁，核实非设备故障',
                  },
                ],
              },
              {
                parkAlarmAlarmId: 'PA20260120010',
                sysAlarmTypeName: '车库积水倒灌',
                sysMaintainUserUserName: '郑十二-市政抢修',
                parkMaintainWorkorderStartTime: 1_737_251_000_000,
                sysDisposalProgressName: '超时处置',
                parkMaintainWorkorderWorkorderNo: 'W20260120010',
                parkMaintainWorkorderExpectedFinishTime: 1_737_254_600_000,
                parkMaintainWorkorderLatestDynamic:
                  '漳州高新区南湖停车场地下车库积水倒灌，排水泵故障，工单超期未处理，已触发二级催办',
                parkMaintainWorkorderDispatchDuration: 1.2,
                parkMaintainWorkorderDealTime: 0,
                parkAlarmEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                disposeAllLog: [
                  {
                    time: 1_737_251_000_000,
                    content: '漳州高新区上报车库积水，生成抢修工单',
                  },
                  {
                    time: 1_737_254_600_000,
                    content: '工单超期，发送催办短信至负责人，同步上报主管',
                  },
                ],
              },
            ]);
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              series: [
                { name: '平均处置时长(小时)', data: [1.8, 2.1, 1.5, 0.9, 3.2] },
              ],
            });
          }, 500);
        });
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              parkMaintainWorkorderLatestDynamic:
                '维保人员已到场，正在维修道闸电机，预计30分钟完成',
              parkAlarmEvidence: [
                'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
              ],
              disposeAllLog: [
                { time: 1_737_283_500_000, content: '工单生成' },
                { time: 1_737_284_000_000, content: '派单至张三' },
                { time: 1_737_285_000_000, content: '张三出发' },
                { time: 1_737_286_000_000, content: '到达现场开始维修' },
              ],
            });
          }, 500);
        });
      ...
      .then((response) => {
        ...
        if (response && Array.isArray(response)) {
          ...
          return response.map((item) => ({
            ...
            parkHiddenDangerRectificationDeadline:
              item.parkHiddenDangerRectificationDeadline,
            tbAssetExtendName: item.tbAssetExtendName,
            ...
            resolve([
              {
                ...
                tbAssetExtendAddress:
                  '漳州市高新区龙江大道北区停车场负一层消防通道',
                parkHiddenDangerInfluenceRange: '整个停车场消防应急逃生',
                sysRectificationProgressName: '未整改',
                parkHiddenDangerRectificationDeadline: 1_737_542_400_000,
                tbAssetExtendName: '北区停车场消防喷淋系统',
                parkHiddenDangerDiscoverTime: 1_737_283_200_000,
              ...
              },
              {
                ...
                parkHiddenDangerRectificationDeadline: 1_737_628_800_000,
                tbAssetExtendName: '南区停车场入口道闸电机',
                parkHiddenDangerDiscoverTime: 1_737_279_600_000,
                ...
                parkHiddenDangerRectifyRequire:
                  '更换道闸电机外壳，调试运行状态，48小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_300_000_000,
                    content: '已采购配件，预计今日到场更换',
                  },
                ],
              },
              {
                ...
                parkHiddenDangerRectificationDeadline: 1_737_369_600_000,
                tbAssetExtendName: '东区停车场应急通道标识',
                parkHiddenDangerDiscoverTime: 1_737_276_000_000,
                ...
                parkHiddenDangerRectifyRequire:
                  '清理占道物品，恢复应急通道畅通，12小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_285_600_000,
                    content: '已清理完毕，通道恢复正常使用',
                  },
                ],
              },
              {
                ...
                sysRectificationProgressName: '已整改',
                parkHiddenDangerRectificationDeadline: 1_737_456_000_000,
                tbAssetExtendName: '西区停车场地面地砖',
                parkHiddenDangerDiscoverTime: 1_737_272_400_000,
                ...
                parkHiddenDangerRectifyRequire:
                  '重新修补地面破损处，保证平整无凸起，72小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  { time: 1_737_350_400_000, content: '已完成修补，等待验收' },
                ],
              },
              {
                parkHiddenDangerHiddenDangerId: 'HD20260119005',
                sysRiskLevelName: '重大',
                sysHiddenDangerTypeName: '电路老化',
                tbAssetExtendAddress:
                  '漳州市芗城区新华北路九龙城停车场负一层配电房',
                parkHiddenDangerInfluenceRange:
                  '整层供电及照明系统、充电桩设备运行',
                sysRectificationProgressName: '超期未整改',
                parkHiddenDangerRectificationDeadline: 1_737_290_400_000,
                tbAssetExtendName: '负一层配电房主供电线路',
                parkHiddenDangerDiscoverTime: 1_737_268_800_000,
                sysUserUserName: '陈七-电力维保负责人',
                parkHiddenDangerAcceptStatus: '待验收',
                parkHiddenDangerEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkHiddenDangerRectifyRequire:
                  '紧急更换老化线路，重新做绝缘处理，排查短路风险，18小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_277_200_000,
                    content: '已下达整改通知，暂无处理进度反馈',
                  },
                ],
              },
              {
                parkHiddenDangerHiddenDangerId: 'HD20260119006',
                sysRiskLevelName: '较大',
                sysHiddenDangerTypeName: '排水堵塞',
                tbAssetExtendAddress:
                  '漳州市龙文区建元东路融信澜园停车场地下车库排水沟',
                parkHiddenDangerInfluenceRange:
                  '车库防涝排水、车辆底盘浸泡风险',
                sysRectificationProgressName: '整改中',
                parkHiddenDangerRectificationDeadline: 1_737_378_000_000,
                tbAssetExtendName: '地下车库主排水沟滤网及管道',
                parkHiddenDangerDiscoverTime: 1_737_265_200_000,
                sysUserUserName: '林八-市政维保负责人',
                parkHiddenDangerAcceptStatus: '待验收',
                parkHiddenDangerEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkHiddenDangerRectifyRequire:
                  '清理排水沟淤泥杂物，疏通堵塞管道，更换破损滤网，36小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_273_600_000,
                    content: '已进场清理，完成主排水沟疏通，滤网备货中',
                  },
                ],
              },
              {
                parkHiddenDangerHiddenDangerId: 'HD20260119007',
                sysRiskLevelName: '一般',
                sysHiddenDangerTypeName: '充电桩故障',
                tbAssetExtendAddress:
                  '漳州市台商投资区角美镇翁角路新能源停车场快充区',
                parkHiddenDangerInfluenceRange:
                  '新能源车辆充电服务、车场运营收益',
                sysRectificationProgressName: '已整改',
                parkHiddenDangerRectificationDeadline: 1_737_346_800_000,
                tbAssetExtendName: '快充区8号9号直流充电桩',
                parkHiddenDangerDiscoverTime: 1_737_261_600_000,
                sysUserUserName: '黄九-新能源运维负责人',
                parkHiddenDangerAcceptStatus: '已验收',
                parkHiddenDangerEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkHiddenDangerRectifyRequire:
                  '检测充电桩模块故障，更换损坏零件，调试充电功率，20小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_270_000_000,
                    content: '更换故障模块，充电桩恢复正常快充功能',
                  },
                  { time: 1_737_272_400_000, content: '验收合格，恢复投用' },
                ],
              },
              {
                parkHiddenDangerHiddenDangerId: 'HD20260119008',
                sysRiskLevelName: '低危',
                sysHiddenDangerTypeName: '标识缺失',
                tbAssetExtendAddress:
                  '漳州市长泰区武安镇人民东路生态停车场人行出入口',
                parkHiddenDangerInfluenceRange: '人员通行指引、车场安全提示',
                sysRectificationProgressName: '整改中',
                parkHiddenDangerRectificationDeadline: 1_737_433_200_000,
                tbAssetExtendName: '人行出入口安全警示标识牌',
                parkHiddenDangerDiscoverTime: 1_737_258_000_000,
                sysUserUserName: '吴十-车场管理负责人',
                parkHiddenDangerAcceptStatus: '待验收',
                parkHiddenDangerEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkHiddenDangerRectifyRequire:
                  '重新制作并安装反光警示标识，补齐缺失的禁行提示牌，24小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_266_400_000,
                    content: '标识牌已制作完成，明日到场安装',
                  },
                ],
              },
              {
                parkHiddenDangerHiddenDangerId: 'HD20260119009',
                sysRiskLevelName: '一般',
                sysHiddenDangerTypeName: '地坪开裂',
                tbAssetExtendAddress:
                  '漳州市云霄县云陵镇江滨路江滨停车场露天停车区',
                parkHiddenDangerInfluenceRange:
                  '车辆轮胎磨损、人员行走绊倒风险',
                sysRectificationProgressName: '已整改',
                parkHiddenDangerRectificationDeadline: 1_737_325_200_000,
                tbAssetExtendName: '露天停车区混凝土地坪',
                parkHiddenDangerDiscoverTime: 1_737_254_400_000,
                sysUserUserName: '郑十一-工程修缮负责人',
                parkHiddenDangerAcceptStatus: '验收通过',
                parkHiddenDangerEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkHiddenDangerRectifyRequire:
                  '填补地坪裂缝，做防滑硬化处理，保证地面平整，16小时内完成整改',
                parkHiddenDangerRectifyLog: [
                  {
                    time: 1_737_262_800_000,
                    content: '裂缝填补完成，硬化处理完毕',
                  },
                  {
                    time: 1_737_265_200_000,
                    content: '现场复核，地坪恢复正常使用标准',
                  },
                ],
              },
            ]);
  ...
  try {
    return requestClient
      ...
      .then((response) => {
        if (
          response &&
          response.parkHiddenDangerHiddenDangerId === hiddenDangerId
        ) {
          return response;
        }
        throw new Error('真实接口返回无详情数据，使用模拟数据兜底');
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              parkHiddenDangerRectifyRequire:
                '立即检修喷淋系统，恢复正常水压，24小时内完成整改，整改后需拍照留存凭证，验收合格后方可闭环',
              parkHiddenDangerRectifyLog: [],
            });
          }, 500);
        });
          ...
          setTimeout(() => {
            resolve({
              ...
              sysRectificationProgressName:
                params.acceptResult === '通过' ? '已完成' : '整改中',
              msg:
            ...
            resolve([
              {
                ...
                parkAbnormalAbnormalTime: 1_737_283_200_000,
              ...
              },
              {
                ...
                parkAbnormalAbnormalReason:
                  '停车场计费系统数据同步延迟，账单金额异常',
                parkAbnormalAbnormalTime: 1_737_279_600_000,
              ...
              },
              {
                ...
                parkAbnormalAbnormalReason:
                  '停车场负二层温湿度传感器报警，湿度超标易短路',
                parkAbnormalAbnormalTime: 1_737_272_400_000,
                tbAssetExtendAddress:
                  '漳州市文旅区湖滨路西区停车场负二层配电室',
                sysAssociatedObjectTypeName: '传感设备',
                parkAbnormalRelieveStatus: '已解除',
                tbAssetExtendName: '西区停车场温湿度传感器',
                sysUserUserName: '赵六-工程运维',
                parkAbnormalRelieveTime: 1_737_350_400_000,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_350_400_000,
                    content: '开启除湿机，温湿度恢复正常值',
                  },
                ],
              },
              {
                parkAbnormalAbnormalId: 'AB20260119005',
                sysAbnormalTypeName: '供电异常',
                parkAbnormalAbnormalReason:
                  '停车场充电桩供电模块短路，多台充电桩停止供电',
                parkAbnormalAbnormalTime: 1_737_268_800_000,
                tbAssetExtendAddress:
                  '漳州市芗城区新华北路九龙城停车场新能源充电区',
                sysAssociatedObjectTypeName: '供电设备',
                parkAbnormalRelieveStatus: '未解除',
                tbAssetExtendName: '新能源充电区总供电模块',
                sysUserUserName: '陈七-电力运维',
                parkAbnormalRelieveTime: null,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_277_200_000,
                    content: '已切断故障区域电源，等待配件到场更换模块',
                  },
                ],
              },
              {
                parkAbnormalAbnormalId: 'AB20260119006',
                sysAbnormalTypeName: '门禁异常',
                parkAbnormalAbnormalReason:
                  '停车场人行通道闸刷卡无反应，人脸识别失效，人员无法通行',
                parkAbnormalAbnormalTime: 1_737_265_200_000,
                tbAssetExtendAddress:
                  '漳州市龙文区建元东路融信澜园停车场人行出入口',
                sysAssociatedObjectTypeName: '门禁设备',
                parkAbnormalRelieveStatus: '整改中',
                tbAssetExtendName: '人行通道人脸识别门禁一体机',
                sysUserUserName: '林八-智能运维',
                parkAbnormalRelieveTime: null,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_273_600_000,
                    content: '已重启门禁系统，人脸识别功能恢复，刷卡功能待调试',
                  },
                ],
              },
              {
                parkAbnormalAbnormalId: 'AB20260119007',
                sysAbnormalTypeName: '设备异常',
                parkAbnormalAbnormalReason:
                  '停车场车位检测器故障，车位占用状态显示错误，引导屏数据不准',
                parkAbnormalAbnormalTime: 1_737_261_600_000,
                tbAssetExtendAddress:
                  '漳州市台商投资区角美镇翁角路万达广场停车场负一层',
                sysAssociatedObjectTypeName: '检测设备',
                parkAbnormalRelieveStatus: '已解除',
                tbAssetExtendName: '负一层车位地磁检测器',
                sysUserUserName: '黄九-车场运维',
                parkAbnormalRelieveTime: 1_737_270_000_000,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_270_000_000,
                    content:
                      '重新校准检测器，车位状态显示正常，引导屏数据同步完成',
                  },
                ],
              },
              {
                parkAbnormalAbnormalId: 'AB20260119008',
                sysAbnormalTypeName: '数据异常',
                parkAbnormalAbnormalReason:
                  '停车场月卡用户权限失效，系统识别不到续费信息，无法进场',
                parkAbnormalAbnormalTime: 1_737_258_000_000,
                tbAssetExtendAddress:
                  '漳州市长泰区武安镇人民东路生态停车场入口岗亭',
                sysAssociatedObjectTypeName: '门禁系统',
                parkAbnormalRelieveStatus: '已解除',
                tbAssetExtendName: '入口岗亭权限识别主机',
                sysUserUserName: '吴十-系统管理',
                parkAbnormalRelieveTime: 1_737_266_400_000,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_266_400_000,
                    content: '同步月卡用户续费数据，权限已恢复正常',
                  },
                ],
              },
              {
                parkAbnormalAbnormalId: 'AB20260119009',
                sysAbnormalTypeName: '通讯异常',
                parkAbnormalAbnormalReason:
                  '停车场道闸远程控制失效，后台无法远程开闸，仅支持现场操作',
                parkAbnormalAbnormalTime: 1_737_254_400_000,
                tbAssetExtendAddress:
                  '漳州市云霄县云陵镇江滨路江滨停车场出口道闸',
                sysAssociatedObjectTypeName: '安防设备',
                parkAbnormalRelieveStatus: '整改中',
                tbAssetExtendName: '出口道闸远程控制模块',
                sysUserUserName: '郑十一-设备维保',
                parkAbnormalRelieveTime: null,
                parkAbnormalEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkAbnormalDisposeLog: [
                  {
                    time: 1_737_262_800_000,
                    content: '检测到控制模块网络故障，正在重新配置网关参数',
                  },
                ],
              },
            ]);
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              series: [
                { name: '异常事件数', data: [8, 12, 9, 15, 10, 13, 11] },
              ],
            });
          }, 500);
        });
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              sysAbnormalTypeName: '设备异常',
              parkAbnormalAbnormalReason:
                '停车场道闸控制板无响应，无法升降，电压检测正常，判定为硬件故障',
              parkAbnormalAbnormalTime: 1_737_283_200_000,
              tbAssetExtendAddress: '漳州市高新区龙江大道北区停车场入口道闸',
              sysAssociatedObjectTypeName: '安防设备',
              parkAbnormalRelieveStatus: '未解除',
            ...
            resolve([
              {
                ...
                tbDeviceExtendInstallPosition:
                  '漳州市高新区龙江大道北区停车场入口道闸',
                parkFaultFaultTime: 1_737_283_200_000,
              ...
              },
              {
                ...
                parkFaultRepairLog: [
                  {
                    time: 1_737_300_000_000,
                    content: '已重装计费软件，正在调试参数',
                  },
                ],
                parkFaultPartsList: [
                  { name: '计费系统授权密钥', count: 1, unit: '个' },
                ],
              ...
              },
              {
                ...
                parkFaultRepairLog: [
                  {
                    time: 1_737_285_600_000,
                    content: '更换网线及水晶头，通讯恢复正常',
                  },
                ],
                parkFaultPartsList: [
                  { name: '超五类网线', count: 2, unit: '米' },
                  { name: '水晶头', count: 2, unit: '个' },
                ],
              ...
              },
              {
                ...
                tbDeviceExtendInstallPosition:
                  '漳州市文旅区湖滨路西区停车场负二层配电室',
                parkFaultFaultTime: 1_737_272_400_000,
                sysMaintenanceProgressName: '已完成',
                tbDeviceExtendDeviceCode: 'CG-202601004',
                parkFaultFaultLevel: '轻微',
                sysMaintainUserUserName: '赵六-工程运维',
                parkMaintainWorkorderExpectedFinishTime: 1_737_350_400_000,
                parkFaultEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkFaultRepairLog: [
                  {
                    time: 1_737_350_400_000,
                    content: '更换电源适配器，设备供电稳定',
                  },
                ],
                parkFaultPartsList: [
                  { name: '12V电源适配器', count: 1, unit: '个' },
                ],
                parkMaintainWorkorderWorkorderNo: 'WD20260119004',
              },
              {
                parkFaultFaultId: 'FT20260119005',
                sysFaultTypeName: '硬件故障',
                sysEquipmentTypeName: '充电桩设备',
                tbDeviceExtendInstallPosition:
                  '漳州市芗城区新华北路九龙城停车场新能源快充区',
                parkFaultFaultTime: 1_737_268_800_000,
                sysMaintenanceProgressName: '未处理',
                tbDeviceExtendDeviceCode: 'CD-202601005',
                parkFaultFaultLevel: '紧急',
                sysMaintainUserUserName: '',
                parkMaintainWorkorderExpectedFinishTime: null,
                parkFaultEvidence: [
              ...
              {
                parkFaultFaultId: 'FT20260119006',
                sysFaultTypeName: '机械故障',
                sysEquipmentTypeName: '通道闸设备',
                tbDeviceExtendInstallPosition:
                  '漳州市龙文区建元东路融信澜园停车场人行通道',
                parkFaultFaultTime: 1_737_265_200_000,
                sysMaintenanceProgressName: '处理中',
                tbDeviceExtendDeviceCode: 'TD-202601006',
                parkFaultFaultLevel: '严重',
                sysMaintainUserUserName: '陈七-设备运维',
                parkMaintainWorkorderExpectedFinishTime: 1_737_351_600_000,
                parkFaultEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkFaultRepairLog: [
                  {
                    time: 1_737_273_600_000,
                    content:
                      '到场检测为齿轮卡滞，已拆卸清理异物，待上润滑油调试',
                  },
                ],
                parkFaultPartsList: [
                  { name: '耐高温润滑油', count: 1, unit: '瓶' },
                  { name: '轴承卡扣', count: 2, unit: '个' },
                ],
                parkMaintainWorkorderWorkorderNo: 'WD20260119005',
              },
              {
                parkFaultFaultId: 'FT20260119007',
                sysFaultTypeName: '线路故障',
                sysEquipmentTypeName: '照明设备',
                tbDeviceExtendInstallPosition:
                  '漳州市台商投资区角美镇翁角路万达广场停车场负一层通道',
                parkFaultFaultTime: 1_737_261_600_000,
                sysMaintenanceProgressName: '已完成',
                tbDeviceExtendDeviceCode: 'ZM-202601007',
                parkFaultFaultLevel: '一般',
                sysMaintainUserUserName: '林八-电力维保',
                parkMaintainWorkorderExpectedFinishTime: 1_737_270_000_000,
                parkFaultEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkFaultRepairLog: [
                  {
                    time: 1_737_270_000_000,
                    content: '更换破损线路及空开，通道照明恢复正常',
                  },
                ],
                parkFaultPartsList: [
                  { name: '铜芯电线', count: 5, unit: '米' },
                  { name: '16A空开', count: 1, unit: '个' },
                ],
                parkMaintainWorkorderWorkorderNo: 'WD20260119006',
              },
              {
                parkFaultFaultId: 'FT20260119008',
                sysFaultTypeName: '软件故障',
                sysEquipmentTypeName: '车位引导设备',
                tbDeviceExtendInstallPosition:
                  '漳州市长泰区武安镇人民东路生态停车场车位引导屏',
                parkFaultFaultTime: 1_737_258_000_000,
                sysMaintenanceProgressName: '已完成',
                tbDeviceExtendDeviceCode: 'YD-202601008',
                parkFaultFaultLevel: '轻微',
                sysMaintainUserUserName: '黄九-系统运维',
                parkMaintainWorkorderExpectedFinishTime: 1_737_266_400_000,
                parkFaultEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkFaultRepairLog: [
                  {
                    time: 1_737_266_400_000,
                    content: '升级引导屏程序版本，车位数据显示正常',
                  },
                ],
                parkFaultPartsList: [
                  { name: '程序升级包', count: 1, unit: '个' },
                ],
                parkMaintainWorkorderWorkorderNo: 'WD20260119007',
              },
              {
                parkFaultFaultId: 'FT20260119009',
                sysFaultTypeName: '通讯故障',
                sysEquipmentTypeName: '道闸设备',
                tbDeviceExtendInstallPosition:
                  '漳州市云霄县云陵镇江滨路江滨停车场出口道闸',
                parkFaultFaultTime: 1_737_254_400_000,
                sysMaintenanceProgressName: '处理中',
                tbDeviceExtendDeviceCode: 'DZ-202601009',
                parkFaultFaultLevel: '一般',
                sysMaintainUserUserName: '吴十-安防运维',
                parkMaintainWorkorderExpectedFinishTime: 1_737_262_800_000,
                parkFaultEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkFaultRepairLog: [
                  {
                    time: 1_737_262_800_000,
                    content: '检测到4G模块信号弱，更换外置天线增强信号',
                  },
                ],
                parkFaultPartsList: [
                  { name: '4G外置天线', count: 1, unit: '个' },
                  { name: '信号放大器', count: 1, unit: '个' },
                ],
                parkMaintainWorkorderWorkorderNo: 'WD20260119008',
              },
            ]);
          }, 500);
        });
          ...
          setTimeout(() => {
            resolve({
              ...
              parkFaultRepairLog: [
                ...
                {
                  time: 1_737_310_000_000,
                  content: '参数调试完成，设备试运行中',
                },
              ],
              parkFaultPartsList: [
                { name: '计费系统授权密钥', count: 1, unit: '个' },
                { name: '系统安装包', count: 1, unit: '份' },
              ],
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            resolve({
              ...
              parkMaintainWorkorderWorkorderNo: `WD${Date.now().toString().slice(-8)}`,
        ...
        if (response && Array.isArray(response)) {
          ...
          return response.map((item) => ({
            ...
            parkComplianceWarningViolationDetail:
              item.parkComplianceWarningViolationDetail,
            parkComplianceWarningWarningTime:
              item.parkComplianceWarningWarningTime,
            tbAssetExtendAddress: item.tbAssetExtendAddress,
            sysRectificationStatusName: item.sysRectificationStatusName,
            parkComplianceWarningComplianceStandard:
              item.parkComplianceWarningComplianceStandard,
            sysResponsibleSubjectTypeName: item.sysResponsibleSubjectTypeName,
            parkComplianceWarningRectificationDeadline:
              item.parkComplianceWarningRectificationDeadline,
            parkComplianceWarningInspectionResult:
              item.parkComplianceWarningInspectionResult,
            parkComplianceWarningEvidence: item.parkComplianceWarningEvidence,
            parkComplianceWarningRectifyLog:
              item.parkComplianceWarningRectifyLog,
          }));
        }
        throw new Error('真实接口返回无核心数据，使用模拟数据兜底');
      })
            ...
            resolve([
              {
                ...
                parkComplianceWarningViolationDetail:
                  '停车场入口通道被商户货物占道，影响车辆正常通行，违反停车场通道畅通管理规范',
                parkComplianceWarningWarningTime: 1_737_283_200_000,
                tbAssetExtendAddress: '漳州市高新区龙江大道北区停车场入口通道',
                sysRectificationStatusName: '未整改',
                parkComplianceWarningComplianceStandard:
                  '停车场所有通行通道宽度需≥3米，无任何占道堆放行为，保障车辆正常通行',
                sysResponsibleSubjectTypeName: '商户主体',
                parkComplianceWarningRectificationDeadline: 1_737_369_600_000,
              ...
              },
              {
                ...
                parkComplianceWarningViolationDetail:
                  '停车场负一层消防栓被遮挡，灭火器压力不足，违反消防安全管理条例相关要求',
                parkComplianceWarningWarningTime: 1_737_279_600_000,
                tbAssetExtendAddress: '漳州市主城区胜利路南区停车场负一层',
                sysRectificationStatusName: '整改中',
                parkComplianceWarningComplianceStandard:
                  '消防设施需保持无遮挡、无损坏、压力正常，每月定期巡检并留存记录',
                sysResponsibleSubjectTypeName: '物业主体',
                parkComplianceWarningRectificationDeadline: 1_737_360_000_000,
                parkComplianceWarningInspectionResult: '未核查',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
              ...
              },
              {
                ...
                parkComplianceWarningViolationDetail:
                  '停车场计费系统未公示收费标准，存在临时车辆超额收费情况，违反物价管理相关规定',
                parkComplianceWarningWarningTime: 1_737_276_000_000,
                tbAssetExtendAddress: '漳州市经开区兴业路东区停车场收费岗亭',
                sysRectificationStatusName: '已整改',
                parkComplianceWarningComplianceStandard:
                  '收费标准需在显著位置公示，计费系统精准计费，无乱收费、超额收费行为',
                sysResponsibleSubjectTypeName: '运营主体',
                parkComplianceWarningRectificationDeadline: 1_737_285_600_000,
              ...
              },
              {
                ...
                parkComplianceWarningViolationDetail:
                  '停车场监控设备存在3处盲区，监控录像留存时长不足30天，违反安防管理规范',
                parkComplianceWarningWarningTime: 1_737_272_400_000,
                tbAssetExtendAddress: '漳州市文旅区湖滨路西区停车场负二层',
                sysRectificationStatusName: '已整改',
                parkComplianceWarningComplianceStandard:
                  '监控设备全覆盖无盲区，录像留存时长≥30天，重要区域监控需实时在线',
                sysResponsibleSubjectTypeName: '安防主体',
                parkComplianceWarningRectificationDeadline: 1_737_350_400_000,
                ...
                parkComplianceWarningRectifyLog: [
                  {
                    time: 1_737_350_400_000,
                    content: '已新增监控摄像头2个，调整录像留存时长为45天',
                  },
                ],
              },
              {
                parkComplianceWarningWarningId: 'HG20260119005',
                sysViolationTypeName: '标识违规',
                parkComplianceWarningViolationDetail:
                  '停车场内无残疾人车位专用标识、无防滑防坠警示标识，应急通道指示牌模糊不清，违反停车场标识规范管理要求',
                parkComplianceWarningWarningTime: 1_737_268_800_000,
                tbAssetExtendAddress: '漳州市芗城区新华北路九龙城停车场负一层',
                sysRectificationStatusName: '未整改',
                parkComplianceWarningComplianceStandard:
                  '停车场需按规范设置各类警示、指引标识，残疾人车位、应急通道标识清晰醒目，无遮挡无模糊，符合国标要求',
                sysResponsibleSubjectTypeName: '物业主体',
                parkComplianceWarningRectificationDeadline: 1_737_356_400_000,
                parkComplianceWarningInspectionResult: '未核查',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
              ...
              {
                parkComplianceWarningWarningId: 'HG20260119006',
                sysViolationTypeName: '设施违规',
                parkComplianceWarningViolationDetail:
                  '停车场人行通道地砖大面积松动破损、排水沟盖板缺失2处，存在人员绊倒摔伤风险，违反停车场基础设施安全管理规范',
                parkComplianceWarningWarningTime: 1_737_265_200_000,
                tbAssetExtendAddress:
                  '漳州市龙文区建元东路融信澜园停车场人行通道',
                sysRectificationStatusName: '整改中',
                parkComplianceWarningComplianceStandard:
                  '停车场地面平整无破损、排水设施完好无缺失，人行通道无安全隐患，基础设施需定期巡检维护并留存台账',
                sysResponsibleSubjectTypeName: '维保主体',
                parkComplianceWarningRectificationDeadline: 1_737_349_200_000,
                parkComplianceWarningInspectionResult: '未核查',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkComplianceWarningRectifyLog: [
                  {
                    time: 1_737_273_600_000,
                    content:
                      '已完成松动地砖修补，排水沟盖板已采购，明日到场安装',
                  },
                ],
              },
              {
                parkComplianceWarningWarningId: 'HG20260119007',
                sysViolationTypeName: '资质违规',
                parkComplianceWarningViolationDetail:
                  '停车场运营方未在显著位置公示停车场备案许可证、消防验收合格证，从业人员无岗上证上岗，违反停车场运营资质管理规定',
                parkComplianceWarningWarningTime: 1_737_261_600_000,
                tbAssetExtendAddress:
                  '漳州市台商投资区角美镇翁角路万达广场停车场管理处',
                sysRectificationStatusName: '已整改',
                parkComplianceWarningComplianceStandard:
                  '停车场需公示完整运营资质文件，从业人员持证上岗，资质文件需在有效期内并及时更新公示',
                sysResponsibleSubjectTypeName: '运营主体',
                parkComplianceWarningRectificationDeadline: 1_737_270_000_000,
                parkComplianceWarningInspectionResult: '通过',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkComplianceWarningRectifyLog: [
                  {
                    time: 1_737_270_000_000,
                    content:
                      '已张贴资质公示牌，补全从业人员岗上证并完成岗前核验',
                  },
                ],
              },
              {
                parkComplianceWarningWarningId: 'HG20260119008',
                sysViolationTypeName: '环保违规',
                parkComplianceWarningViolationDetail:
                  '停车场垃圾收集点未分类设置、垃圾桶满溢未及时清理，充电桩区域油污渗漏未处理，违反停车场环境卫生管理规范',
                parkComplianceWarningWarningTime: 1_737_258_000_000,
                tbAssetExtendAddress:
                  '漳州市长泰区武安镇人民东路生态停车场新能源充电区',
                sysRectificationStatusName: '已整改',
                parkComplianceWarningComplianceStandard:
                  '停车场需按要求分类设置垃圾收集设施，及时清理清运，设备区域无油污渗漏，保持场地整洁无杂物堆积',
                sysResponsibleSubjectTypeName: '保洁主体',
                parkComplianceWarningRectificationDeadline: 1_737_266_400_000,
                parkComplianceWarningInspectionResult: '未通过',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkComplianceWarningRectifyLog: [
                  {
                    time: 1_737_266_400_000,
                    content: '已更换分类垃圾桶，清理油污并做防渗漏处理，待复检',
                  },
                ],
              },
              {
                parkComplianceWarningWarningId: 'HG20260119009',
                sysViolationTypeName: '管理违规',
                parkComplianceWarningViolationDetail:
                  '停车场出入口无人值守、车辆进出未登记，外来陌生车辆随意进场停放，存在财产安全及治安管理风险，违反车场安保管理规范',
                parkComplianceWarningWarningTime: 1_737_254_400_000,
                tbAssetExtendAddress:
                  '漳州市云霄县云陵镇江滨路江滨停车场出入口岗亭',
                sysRectificationStatusName: '整改中',
                parkComplianceWarningComplianceStandard:
                  '经营性停车场需专人值守，外来车辆实名登记进场，建立车辆进出台账，重要时段加强巡逻频次，保障车场治安安全',
                sysResponsibleSubjectTypeName: '安保主体',
                parkComplianceWarningRectificationDeadline: 1_737_262_800_000,
                parkComplianceWarningInspectionResult: '未核查',
                parkComplianceWarningEvidence: [
                  'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg',
                ],
                parkComplianceWarningRectifyLog: [
                  {
                    time: 1_737_262_800_000,
                    content:
                      '已安排安保人员定岗值守，启用车辆进出登记台账，完成系统登记调试',
                  },
                ],
              },
            ]);
...
export const fetchParkComplianceWarningDetail = (warningId, params = {}) => {
  try {
    ...
    console.error(
      '===== fetchParkComplianceWarningDetail 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
    return Promise.resolve({});
...
export const submitParkComplianceWarningRectify = (params = {}) => {
  try {
    ...
    console.error(
      '===== submitParkComplianceWarningRectify 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
    return Promise.reject(new Error('整改提交失败，请稍后重试'));
...
export const submitParkComplianceWarningInspect = (params = {}) => {
  try {
    ...
    console.error(
      '===== submitParkComplianceWarningInspect 函数初始化异常 =====',
    );
    console.error('错误信息:', error.message);
    console.error('错误堆栈:', error.stack);
