...
// 饼图切换相关
const activePieType = ref('mentalStatus'); // 'mentalStatus' 或 'riskLevel'
const pieOptions = [
...
const cardList = computed(() => {
  ...
  return [
    ...
    { title: '风险等级高', value: data.highRiskLevelCount || 0, color: '#F56C6C', status: 'highRiskLevel' },
