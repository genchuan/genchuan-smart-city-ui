...
export const ResponsibilityManagementApi = {
  ...
  getResponsibilityManagementPage: async (params: any) => {
    return await request.get({ url: `/waterdetection/responsibility-management/page`, params })
  },

  // 查询责任单位及责任人管理详情
  getResponsibilityManagement: async (id: number) => {
    return await request.get({ url: `/waterdetection/responsibility-management/get?id=` + id })
  },

  // 新增责任单位及责任人管理
  createResponsibilityManagement: async (data: ResponsibilityManagementVO) => {
    return await request.post({ url: `/waterdetection/responsibility-management/create`, data })
  },

  // 修改责任单位及责任人管理
  updateResponsibilityManagement: async (data: ResponsibilityManagementVO) => {
    return await request.put({ url: `/waterdetection/responsibility-management/update`, data })
  },

  // 删除责任单位及责任人管理
  deleteResponsibilityManagement: async (id: number) => {
    return await request.delete({ url: `/waterdetection/responsibility-management/delete?id=` + id })
  },

  // 导出责任单位及责任人管理 Excel
  exportResponsibilityManagement: async (params) => {
    return await request.download({ url: `/waterdetection/responsibility-management/export-excel`, params })
  },
}
