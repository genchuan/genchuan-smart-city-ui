...
import {
  InspectionInspectionPlanApi,
} from '#/api/genchuan/shunchangOpsService/smartcity/list/supervisionInspection/inspectionPatrolManagement/inspectioninspectionplan';
  ...
  <ElDialog :title="dialogTitle" v-model="dialogVisible" width="600px" append-to-body>
    ...
    >
      <ElFormItem label="巡查项目" prop="inspectionProject">
        <ElInput v-model="formData.inspectionProject" placeholder="请输入巡查项目" />
      </ElFormItem>
      ...
      <ElFormItem label="巡查方式" prop="inspectionMethod">
        <ElInput v-model="formData.inspectionMethod" placeholder="请输入巡查方式" />
      </ElFormItem>
