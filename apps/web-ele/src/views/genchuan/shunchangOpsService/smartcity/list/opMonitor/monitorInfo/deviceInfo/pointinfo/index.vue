...
const handleDelete = async (id: number) => {
  try {
    // 删除的二次确认
    await confirm('是否确认删除该监测点位数据？', '系统提示');
    // 发起删除
...
const handleExport = async () => {
  try {
    // 导出的二次确认
    await confirm('是否确认导出所有监测点位数据？', '系统提示');
    // 发起导出
  ...
  <div class="p-4">
    ...
    <ElCard shadow="never">
      <ElTable
        ...
        style="width: 100%"
      >
        <ElTableColumn label="主键" align="center" prop="id" min-width="50px" />
        <ElTableColumn label="点位编号" align="center" prop="pointNumber" />
