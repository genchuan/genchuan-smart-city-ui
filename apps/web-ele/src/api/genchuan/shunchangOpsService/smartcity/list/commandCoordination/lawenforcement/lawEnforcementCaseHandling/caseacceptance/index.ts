...
export const CaseAcceptanceApi = {
  ...
  getCaseAcceptancePage: async (params: any) => {
    return await requestClient.get(`/smartcity/case-acceptance/page`, {
      params,
    });
  },
  ...
  getCaseAcceptance: async (id: number) => {
    return await requestClient.get(`/smartcity/case-acceptance/get`, {
      params: { id },
    });
  },
  ...
  deleteCaseAcceptance: async (id: number) => {
    return await requestClient.delete(`/smartcity/case-acceptance/delete`, {
      params: { id },
    });
  },
  ...
  exportCaseAcceptance: async (params) => {
    return await requestClient.download(
      `/smartcity/case-acceptance/export-excel`,
      params,
    );
  },
};
