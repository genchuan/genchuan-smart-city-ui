    ...
    <DetailDrawer :title="`${dataObj.detailObj.name}关联表`">
      <div class="detail-card">
        ...
        <div class="detail-card-row">
          ...
          <div class="detail-row-right">
            {{ dataObj.detailObj.space_id }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">寻车时间:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.search_time }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">车位定位信息:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.location_info }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">导航路径信息:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.route_info }}
          </div>
        </div>
