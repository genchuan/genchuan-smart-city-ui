    ...
    <div class="legend">
      <div class="legend-items">
        <div class="legend-item">
          <img :src="getLegendIcon('staff')" class="legend-icon" alt="环卫人员" />
          <span>环卫人员</span>
        </div>
        <div class="legend-item">
          <img :src="getLegendIcon('vehicle')" class="legend-icon" alt="环卫车辆" />
          <span>环卫车辆</span>
        </div>
        <div class="legend-item">
          <img :src="getLegendIcon('station')" class="legend-icon" alt="环卫站点" />
          <span>环卫站点</span>
        </div>
      </div>
    </div>
...
const handleMarkerAction = (action) => {
  ...
  const actions = {
    'contact': `正在联系环卫人员 ${selectedMarker.value.properties.title}...`,
