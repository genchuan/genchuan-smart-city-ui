...
import { buildLatestStatsData, getMockReports } from './data';
...
const reports = ref<UserOpReportRow[]>(getMockReports());
...
const statsData = computed(() => buildLatestStatsData(reports.value));
</script>
