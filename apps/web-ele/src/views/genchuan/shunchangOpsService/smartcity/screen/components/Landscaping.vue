...
const geometriesArray = [
  { x: 26.925_227, y: 117.680_114 },
  { x: 26.783_322_7, y: 117.720_114 },
  { x: 26.863_227, y: 117.852_011_4 },
];
...
const centerData = ref({
  customizeParams: getRunningDaysConfig('连续养护天数：'),
  proJectsList: {
    processName: '施工工艺',
    ...
    listData: [
      {
        ...
        realPictures: [
          {
            imgUrl: new URL('../assets/images/imgs/22.jpg', import.meta.url)
              .href,
            name: '机械辅助修剪',
          },
          {
            imgUrl: new URL('../assets/images/imgs/11.jpeg', import.meta.url)
              .href,
            name: '人工修剪',
          },
        ],
