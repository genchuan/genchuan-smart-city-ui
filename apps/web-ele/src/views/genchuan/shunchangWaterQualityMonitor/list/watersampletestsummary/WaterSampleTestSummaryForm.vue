...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value =
        await WaterSampleTestSummaryApi.getWaterSampleTestSummary(id);
    } finally {
  ...
  >
    ...
    >
      ...
      <ElFormItem label="氨(以N计)(mg/L)" prop="ammoniaN">
        <ElInput
          v-model="formData.ammoniaN"
          placeholder="请输入氨(以N计)(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="大肠埃希氏菌(CFU/100mL)" prop="escherichiaColi">
        <ElInput
          ...
          placeholder="请输入大肠埃希氏菌(CFU/100mL)"
        />
      </ElFormItem>
      <ElFormItem label="二氯一溴甲烷(mg/L)" prop="dichlorobromomethane">
        <ElInput
          v-model="formData.dichlorobromomethane"
          placeholder="请输入二氯一溴甲烷(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="二氯乙酸(mg/L)" prop="dichloroaceticAcid">
        <ElInput
          v-model="formData.dichloroaceticAcid"
          placeholder="请输入二氯乙酸(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="二氧化氯(mg/L)" prop="chlorineDioxide">
        <ElInput
          v-model="formData.chlorineDioxide"
          placeholder="请输入二氧化氯(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="高锰酸盐指数(以O2计)(mg/L)" prop="permanganateIndex">
        <ElInput
          v-model="formData.permanganateIndex"
          placeholder="请输入高锰酸盐指数(以O2计)(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="铬(六价)(mg/L)" prop="chromium">
        <ElInput
          v-model="formData.chromium"
          placeholder="请输入铬(六价)(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="菌落总数(CFU/mL)" prop="totalBacteriaCount">
        <ElInput
          v-model="formData.totalBacteriaCount"
          placeholder="请输入菌落总数(CFU/mL)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="溶解性总固体(mg/L)" prop="dissolvedSolids">
        <ElInput
          v-model="formData.dissolvedSolids"
          placeholder="请输入溶解性总固体(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="肉眼可见物" prop="visibleObject">
        <ElInput
          v-model="formData.visibleObject"
          placeholder="请输入肉眼可见物"
        />
      </ElFormItem>
      <ElFormItem label="三卤甲烷" prop="trihalomethanes">
        <ElInput
          v-model="formData.trihalomethanes"
          placeholder="请输入三卤甲烷"
        />
      </ElFormItem>
      <ElFormItem label="三氯甲烷(mg/L)" prop="chloroform">
        <ElInput
          v-model="formData.chloroform"
          placeholder="请输入三氯甲烷(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="三氯乙酸(mg/L)" prop="trichloroaceticAcid">
        <ElInput
          v-model="formData.trichloroaceticAcid"
          placeholder="请输入三氯乙酸(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="三溴甲烷(mg/L)" prop="bromoform">
        <ElInput
          v-model="formData.bromoform"
          placeholder="请输入三溴甲烷(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="硝酸盐(以N计)(mg/L)" prop="nitrateN">
        <ElInput
          v-model="formData.nitrateN"
          placeholder="请输入硝酸盐(以N计)(mg/L)"
        />
      </ElFormItem>
      ...
      <ElFormItem label="亚氯酸盐(mg/L)" prop="chlorite">
        <ElInput
          v-model="formData.chlorite"
          placeholder="请输入亚氯酸盐(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="一氯二溴甲烷(mg/L)" prop="dibromochloromethane">
        <ElInput
          v-model="formData.dibromochloromethane"
          placeholder="请输入一氯二溴甲烷(mg/L)"
        />
      </ElFormItem>
      <ElFormItem label="总α放射性(Bq/L)" prop="totalAlphaRadioactivity">
        <ElInput
          v-model="formData.totalAlphaRadioactivity"
          placeholder="请输入总α放射性(Bq/L)"
        />
      </ElFormItem>
      <ElFormItem label="总β放射性(Bq/L)" prop="totalBetaRadioactivity">
        <ElInput
          v-model="formData.totalBetaRadioactivity"
          placeholder="请输入总β放射性(Bq/L)"
        />
      </ElFormItem>
      <ElFormItem label="总大肠菌群(CFU/100mL)" prop="totalColiform">
        <ElInput
          v-model="formData.totalColiform"
          placeholder="请输入总大肠菌群(CFU/100mL)"
        />
      </ElFormItem>
      <ElFormItem label="总硬度(以CaCO3计)(mg/L)" prop="totalHardness">
        <ElInput
          v-model="formData.totalHardness"
          placeholder="请输入总硬度(以CaCO3计)(mg/L)"
        />
      </ElFormItem>
    </ElForm>
    <template #footer>
