...
import * as pageApi from '#/api/genchuan/industry/chargePark/stationResource/stationMgmt/stationConfig/index.js';
...
.station-resource-leaf-page {
  ...
  .station-overview :deep(.park-chart-box) {
    margin-bottom: 0;
  }
  ...
  .park-lot-table-new :deep(.filter-tags-container) {
    display: flex;
    flex-wrap: wrap;
    gap: 8px;
    align-items: center;
  ...
  .park-lot-table-new :deep(.filter-tags-container .el-tag) {
    height: 32px;
