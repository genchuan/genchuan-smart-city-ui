...
import { importGarbageCollection } from '#/api/genchuan/industry/urbanmanagement/environmentalSanitation/sanitationSceneMgmt/garbageCollection/data.js'; // 你的导入API路径
