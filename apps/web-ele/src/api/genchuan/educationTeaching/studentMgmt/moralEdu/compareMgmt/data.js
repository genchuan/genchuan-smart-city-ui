...
export function getCompareMgmtPage(params) {
  return requestClient.get('/studentmgmt/compare-mgmt/page', { params }).catch(err => {
...
export function createCompareMgmt(data) {
  return requestClient.post('/studentmgmt/compare-mgmt/create', data).catch(err => {
...
export function updateCompareMgmt(data) {
  return requestClient.put('/studentmgmt/compare-mgmt/update', data).catch(err => {
...
export function exportCompareMgmt(params) {
  return requestClient.download('/studentmgmt/compare-mgmt/export', params).catch(err => {
...
export function getCompareMgmtDetail(params) {
  return requestClient.get('/studentmgmt/compare-mgmt/get', { params }).catch(err => {
