<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:test-progress:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:test-progress:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="当前进度(%)" align="center" prop="progressPercent" />
      <el-table-column label="已完成指标" align="center" prop="completedIndicators" />
      <el-table-column label="未完成指标" align="center" prop="pendingIndicators" />
      <el-table-column
        label="预计完成时间"
        align="center"
        ...
        width="180px"
      />
      <el-table-column label="延迟原因(如有)" align="center" prop="delayReason" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['waterdetection:test-progress:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['waterdetection:test-progress:delete']"
          >
            删除
          </el-button>
        </template>
...
const list = ref<TestProgressVO[]>([]) // 列表的数据
