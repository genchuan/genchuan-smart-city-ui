...
import markerScenicGreen from '../images/mountain_normal.png';
import markerScenicRed from '../images/mountain_abnormal.png';
import markerVenueGreen from '../images/building_normal.png';
import markerVenueRed from '../images/building_abnormal.png';
