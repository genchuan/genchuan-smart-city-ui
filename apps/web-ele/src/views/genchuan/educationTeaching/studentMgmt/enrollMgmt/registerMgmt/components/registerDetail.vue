...
const drawerTitle = computed(() => {
  const name = detailObj.value?.studentName ? `${detailObj.value.studentName} 报名详情` : '报名详情';
...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      <!-- 基础信息 -->
      <div class="detail-section">📋 报名基础信息</div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">报名时间：</div><div class="detail-row-right">{{ formatTimestamp(detailObj.applyTime) }}</div></div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">录取确认时间：</div><div class="detail-row-right">{{ formatTimestamp(detailObj.confirmTime) }}</div></div>
