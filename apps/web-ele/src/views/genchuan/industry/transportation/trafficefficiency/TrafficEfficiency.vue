...
} from '#/api/genchuan/industry/transportation/SubdomainScenarioTopics.js';
...
const initData = async () => {
  ...
  congestionBarData.value = await fetchTrafficCongestionDistribution();
