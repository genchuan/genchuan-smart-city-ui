<!-- 文件4: components/fundDetail.vue (详情抽屉) -->
<script setup>
...
const drawerTitle = computed(() => {
  const name = detailObj.value?.studentName || '资助';
  return title.value || `${name}资助详情`;
});
...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      <div class="detail-section">💰 资助申请信息</div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">资助类型：</div><div class="detail-row-right">{{ detailObj.fundType || '-' }}</div></div>
