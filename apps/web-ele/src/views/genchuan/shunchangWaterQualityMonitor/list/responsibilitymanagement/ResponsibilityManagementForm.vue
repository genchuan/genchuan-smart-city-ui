  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="责任类型" prop="responsibilityType">
        <el-input v-model="formData.responsibilityType" placeholder="请输入责任类型(主体责任/监管责任/运行管理责任)" />
      </el-form-item>
      ...
      <el-form-item label="责任范围" prop="responsibilityScope">
        <el-input v-model="formData.responsibilityScope" placeholder="请输入责任范围" />
      </el-form-item>
    </el-form>
    <template #footer>
...
const formRules = reactive({
  responsibilityType: [{ required: true, message: '责任类型(主体责任/监管责任/运行管理责任)不能为空', trigger: 'blur' }],
