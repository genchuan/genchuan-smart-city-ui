...
export const EventProcessingApi = {
  ...
  getEventProcessingPage: async (params: any) => {
    return await requestClient.get(`/smartcity/event-processing/page`, {
      params,
    });
  },
  ...
  getEventProcessing: async (id: number) => {
    return await requestClient.get(`/smartcity/event-processing/get`, {
      params: { id },
    });
  },
  ...
  deleteEventProcessing: async (id: number) => {
    return await requestClient.delete(`/smartcity/event-processing/delete`, {
      params: { id },
    });
  },
  ...
  exportEventProcessing: async (params) => {
    return await requestClient.download(
      `/smartcity/event-processing/export-excel`,
      params,
    );
  },
};
