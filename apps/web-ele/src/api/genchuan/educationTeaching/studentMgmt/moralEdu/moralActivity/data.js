...
function convertEnToZh(obj) {
  ...
  if (
    result.hostDept &&
    typeof result.hostDept === 'number' &&
    deptIdToName[result.hostDept]
  ) {
...
export function getMoralActivityPage(params) {
  ...
  return requestClient
    .get('/studentmgmt/moral-activity/page', { params: convertedParams })
    .then((res) => {
      if (res && res.list) {
...
export function createMoralActivity(data) {
  ...
  return requestClient
    .post('/studentmgmt/moral-activity/create', convertedData)
    .catch((error) => {
...
export function updateMoralActivity(data) {
  const convertedData = convertZhToEn(data);
  return requestClient
    .put('/studentmgmt/moral-activity/update', convertedData)
    .catch((error) => {
...
export function publishMoralActivity(ids) {
  return requestClient
    .put('/studentmgmt/moral-activity/publish', { ids })
    .catch((error) => {
      console.warn('发布接口失败，模拟成功', error);
      return true;
    });
}
...
export function recordMoralActivity(data) {
  return requestClient
    .put('/studentmgmt/moral-activity/record', data)
    .catch((error) => {
      console.warn('记录接口失败，模拟成功', error);
      return true;
    });
}
...
export function exportMoralActivity(params) {
  const convertedParams = convertZhToEn(params);
  return requestClient
    .download('/studentmgmt/moral-activity/export-excel', convertedParams)
    .catch((error) => {
...
export function getMoralActivityDetail(params) {
  return requestClient
    .get('/studentmgmt/moral-activity/get', { params })
...
export function getStudentOptions(params) {
  return requestClient
    .get('/studentmgmt/student/options', { params })
    .catch((error) => {
      console.warn('获取学生列表失败，使用模拟数据', error);
      return [
        { value: 1, label: '张三' },
        { value: 2, label: '李四' },
        { value: 3, label: '王五' },
...
export function getDeptOptions(params) {
  return requestClient
    .get('/studentmgmt/dept/options', { params })
    .catch((error) => {
      console.warn('获取部门列表失败，使用模拟数据', error);
      return [
        {
          id: 1001,
          name: '学生工作部',
...
export function getMoralActivityChart(params) {
  return requestClient
    .get('/studentmgmt/moral-activity/chart', { params })
    .catch((error) => {
...
export function getMoralActivityCount(params) {
  return requestClient
    .get('/studentmgmt/moral-activity/chart/activityCount', { params })
    .then((res) => {
