...
export const ComponentInformationApi = {
  ...
  getComponentInformationPage: async (params: any) => {
    return await requestClient.get(`/smartcity/component-information/page`, { params });
  },

  // 查询部件信息详情
  getComponentInformation: async (id: number) => {
    return await requestClient.get(`/smartcity/component-information/get`, { params: { id } });
  },

  // 新增部件信息
  createComponentInformation: async (data: any) => {
    return await requestClient.post(`/smartcity/component-information/create`, data);
  },

  // 修改部件信息
  updateComponentInformation: async (data: any) => {
    return await requestClient.put(`/smartcity/component-information/update`, data);
  },

  // 删除部件信息
  deleteComponentInformation: async (id: number) => {
    return await requestClient.delete(`/smartcity/component-information/delete`, { params: { id } });
  },

  // 导出部件信息 Excel
  exportComponentInformation: async (params) => {
    return await requestClient.download(`/smartcity/component-information/export-excel`, params);
  },
};
