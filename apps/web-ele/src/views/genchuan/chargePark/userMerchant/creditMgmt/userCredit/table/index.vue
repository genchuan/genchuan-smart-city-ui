...
import type { UserCreditDetailVO } from '#/api/genchuan/chargePark/userMerchant/creditMgmt/userCredit';
...
import { UserCreditApi } from '#/api/genchuan/chargePark/userMerchant/creditMgmt/userCredit';
