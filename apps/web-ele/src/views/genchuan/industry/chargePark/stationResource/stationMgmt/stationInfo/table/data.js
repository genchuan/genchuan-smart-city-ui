...
export const detailFields = [
  ...
  { key: 'spaceTotal', label: '泊位总数', section: '基础信息' },
  { key: 'userId', label: '负责人', section: '基础信息' },
  { key: 'feeStandard', label: '场站收费标准', section: '基础信息' },
  { key: 'areaName', label: '所属片区', section: '基础信息' },
  { key: 'operateType', label: '运营类型', section: '基础信息' },
  { key: 'status', label: '状态', section: '基础信息' },
  { key: 'deviceCount', label: '设备绑定数', section: '基础信息' },
  { key: 'spaceCount', label: '车位绑定数', section: '基础信息' },
  { key: 'remark', label: '备注', section: '基础信息' },
];
