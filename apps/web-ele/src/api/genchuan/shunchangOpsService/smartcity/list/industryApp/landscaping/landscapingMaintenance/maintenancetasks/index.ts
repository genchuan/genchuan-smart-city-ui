...
export const MaintenanceTasksApi = {
  ...
  getMaintenanceTasksPage: async (params: any) => {
    return await requestClient.get(`/smartcity/maintenance-tasks/page`, {
      params,
    });
  },
  ...
  getMaintenanceTasks: async (id: number) => {
    return await requestClient.get(`/smartcity/maintenance-tasks/get`, {
      params: { id },
    });
  },
  ...
  createMaintenanceTasks: async (data: any) => {
    return await requestClient.post(
      `/smartcity/maintenance-tasks/create`,
      data,
    );
  },
  ...
  deleteMaintenanceTasks: async (id: number) => {
    return await requestClient.delete(`/smartcity/maintenance-tasks/delete`, {
      params: { id },
    });
  },
  ...
  exportMaintenanceTasks: async (params) => {
    return await requestClient.download(
      `/smartcity/maintenance-tasks/export-excel`,
      params,
    );
  },
};
