...
import { ScrollBoard, ActiveRingChart, WaterLevelPond, CapsuleChart } from '@kjgl77/datav-vue3';
    ...
    <div class="content-center">
      ...
      <div class="s2 bg">
        ...
        <div class="WaterConservancyAndWaterAffairs-center-css">
          <ActiveRingChart :config="centerData.option2" style="width:50%;height:100%;" />
        <WaterLevelPond :config="centerData.option4" style="width:200px;height:calc(100% - 35px); margin-right:90px" />
        </div>
        <!--<chart-type-line2
