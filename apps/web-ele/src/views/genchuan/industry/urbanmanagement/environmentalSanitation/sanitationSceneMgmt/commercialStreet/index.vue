...
import {
  dataList,
} from '#/api/genchuan/industry/urbanmanagement/environmentalSanitation/sanitationSceneMgmt/commercialStreet/data.js';
import {
  textObj,
  useFormSchema,
  getColumnsByStatus,
} from '#/api/genchuan/industry/urbanmanagement/environmentalSanitation/sanitationSceneMgmt/commercialStreet/form.js';
      ...
      <template #bottom>
        <div class="common-total" @click="dataObj.totalShow = !dataObj.totalShow">
          ...
          <span>本页统计：任务总数{{
              ...
              dataObj.list.filter(v => v.status === '收运待执行').length
            }}; 设施待维护{{
