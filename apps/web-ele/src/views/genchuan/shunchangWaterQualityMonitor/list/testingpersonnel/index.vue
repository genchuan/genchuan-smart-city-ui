<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="资格证书编号" label-width="auto" prop="certificateNo">
        <el-input
      ...
      <el-form-item label="所属机构编号" label-width="auto" prop="agencyCode">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:testing-personnel:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['waterdetection:testing-personnel:export']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="人员编号" align="center" prop="staffNo" />
      <el-table-column label="姓名" align="center" prop="staffName" />
      <el-table-column label="职称" align="center" prop="position" />
      <el-table-column label="资格证书编号" align="center" prop="certificateNo" />
      <el-table-column label="培训记录" align="center" prop="trainingRecord" />
      <el-table-column label="所属机构编号" align="center" prop="agencyCode" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['waterdetection:testing-personnel:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['waterdetection:testing-personnel:delete']"
          >
            删除
          </el-button>
        </template>
...
const list = ref<TestingPersonnelVO[]>([]) // 列表的数据
