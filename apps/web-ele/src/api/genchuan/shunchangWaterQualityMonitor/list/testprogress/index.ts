...
export const TestProgressApi = {
  ...
  getTestProgressPage: async (params: any) => {
    return await requestClient.get(`/waterdetection/test-progress/page`, {
      params,
    });
  },
  ...
  getTestProgress: async (id: number) => {
    return await requestClient.get(`/waterdetection/test-progress/get`, {
      params: { id },
    });
  },
  ...
  deleteTestProgress: async (id: number) => {
    return await requestClient.delete(`/waterdetection/test-progress/delete`, {
      params: { id },
    });
  },
