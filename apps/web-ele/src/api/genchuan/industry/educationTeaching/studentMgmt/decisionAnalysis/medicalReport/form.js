...
export function useGridColumns() {
  return [
    ...
    { field: 'treatTotal', title: '就诊总人数', minWidth: 130, sortable: true, slots: { default: 'treatTotal' } },
    { field: 'applyNum', title: '预约数', minWidth: 120, sortable: true, slots: { default: 'applyNum' } },
    { field: 'treatFinishRate', title: '就诊完成率(%)', minWidth: 150, sortable: true },
    { field: 'flowEfficiency', title: '流程节点效率(%)', minWidth: 160, sortable: true },
    ...
    { field: 'treatTotalYoy', title: '就诊总人数同比(%)', minWidth: 160, sortable: true },
    { field: 'treatTotalQoq', title: '就诊总人数环比(%)', minWidth: 160, sortable: true },
    { field: 'applyNumYoy', title: '预约数同比(%)', minWidth: 150, sortable: true },
    { field: 'applyNumQoq', title: '预约数环比(%)', minWidth: 150, sortable: true },
...
export const detailFields = [
  ...
  { key: 'treatTotal', label: '就诊总人数' },
  { key: 'applyNum', label: '预约数' },
  { key: 'treatFinishRate', label: '就诊完成率(%)' },
  { key: 'flowEfficiency', label: '流程节点效率(%)' },
  ...
  { key: 'treatTotalYoy', label: '就诊总人数同比(%)' },
  { key: 'treatTotalQoq', label: '就诊总人数环比(%)' },
  { key: 'applyNumYoy', label: '预约数同比(%)' },
  { key: 'applyNumQoq', label: '预约数环比(%)' },
