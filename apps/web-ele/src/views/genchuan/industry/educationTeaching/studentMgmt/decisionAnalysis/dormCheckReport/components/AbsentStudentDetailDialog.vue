...
import { getAbsentStudentDetailList } from '#/api/genchuan/industry/educationTeaching/studentMgmt/decisionAnalysis/dormCheckReport/data.js';
...
const fetchData = async (params) => {
  ...
  const res = await getAbsentStudentDetailList({
  ...
  if (res.code === 200) {
    ...
    console.error('获取缺勤学生明细失败', res.msg);
    return { list: [], total: 0 };
  }
};
