...
export const TestResultApi = {
  ...
  getTestResultPage: async (params: any) => {
    return await requestClient.get(
      `/waterdetection/test-result/page`,
      { params },
    );
  },
  ...
  getTestResult: async (id: number) => {
    return await requestClient.get(
      `/waterdetection/test-result/get`,
      { params: { id } },
    );
  },
  ...
  createTestResult: async (data: TestResultVO) => {
    return await requestClient.post(
      `/waterdetection/test-result/create`,
      data,
    );
  },
  ...
  updateTestResult: async (data: TestResultVO) => {
    return await requestClient.put(
      `/waterdetection/test-result/update`,
      data,
    );
  },
  ...
  deleteTestResult: async (id: number) => {
    return await requestClient.delete(
      `/waterdetection/test-result/delete`,
      { params: { id } },
    );
  },
