...
export const CaseInvestigationApi = {
  ...
  getCaseInvestigationPage: async (params: any) => {
    return await requestClient.get(`/smartcity/case-investigation/page`, { params });
  },

  // 查询案件调查详情
  getCaseInvestigation: async (id: number) => {
    return await requestClient.get(`/smartcity/case-investigation/get`, { params: { id } });
  },

  // 新增案件调查
  createCaseInvestigation: async (data: any) => {
    return await requestClient.post(`/smartcity/case-investigation/create`, data);
  },

  // 修改案件调查
  updateCaseInvestigation: async (data: any) => {
    return await requestClient.put(`/smartcity/case-investigation/update`, data);
  },

  // 删除案件调查
  deleteCaseInvestigation: async (id: number) => {
    return await requestClient.delete(`/smartcity/case-investigation/delete`, { params: { id } });
  },

  // 导出案件调查 Excel
  exportCaseInvestigation: async (params) => {
    return await requestClient.download(`/smartcity/case-investigation/export-excel`, params);
  },
};
