...
<template>
  <DetailDrawer :title="title || `任务详情 - ${detailObj.taskName}`">
    <div class="detail-card">
      <div class="detail-card-row">
        <div class="detail-row-left">任务名称:</div>
        <div class="detail-row-right">{{ detailObj.taskName }}</div>
      </div>
      <div class="detail-card-row">
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">分配人:</div>
        <div class="detail-row-right">{{ detailObj.assigner }}</div>
      </div>
      <div class="detail-card-row">
