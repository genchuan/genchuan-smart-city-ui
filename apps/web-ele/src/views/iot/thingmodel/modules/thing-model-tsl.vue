...
import { ElDialog, ElRadio, ElRadioGroup, ElRadioButton, ElInput } from 'element-plus';
  ...
  >
    <div class="mode-switch">
      <el-radio-group v-model="viewMode" size="small">
        <el-radio-button value="view">代码视图</el-radio-button>
        <el-radio-button value="editor">编辑器视图</el-radio-button>
      </el-radio-group>
    </div>
