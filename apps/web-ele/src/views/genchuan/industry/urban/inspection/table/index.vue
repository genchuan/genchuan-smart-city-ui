...
import { getInspectionList } from '#/api/genchuan/industry/urban/index.js';
import { refreshSync } from '#/api/genchuan/industry/vehicle/entry.js';
...
const getTableData = async (pageObj) => {
  ...
  const data = await getInspectionList(getParams);
