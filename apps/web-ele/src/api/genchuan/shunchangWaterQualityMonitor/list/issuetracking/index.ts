...
export const IssueTrackingApi = {
  ...
  getIssueTrackingPage: async (params: any) => {
    return await requestClient.get(`/waterdetection/issue-tracking/page`, {
      params,
    });
  },
  ...
  getIssueTracking: async (id: number) => {
    return await requestClient.get(`/waterdetection/issue-tracking/get`, {
      params: { id },
    });
  },
  ...
  deleteIssueTracking: async (id: number) => {
    return await requestClient.delete(`/waterdetection/issue-tracking/delete`, {
      params: { id },
    });
  },
