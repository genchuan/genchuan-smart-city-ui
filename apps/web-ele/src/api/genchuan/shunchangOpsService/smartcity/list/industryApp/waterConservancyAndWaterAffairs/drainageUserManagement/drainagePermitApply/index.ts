...
export const DrainagePermitApplyApi = {
  ...
  getDrainagePermitApplyPage: async (params: any) => {
    return await requestClient.get(`/smartcity/drainage-permit-apply/page`, { params });
  },

  // 查询排水许可证申请详情
  getDrainagePermitApply: async (id: number) => {
    return await requestClient.get(`/smartcity/drainage-permit-apply/get`, { params: { id } });
  },

  // 新增排水许可证申请
  createDrainagePermitApply: async (data: any) => {
    return await requestClient.post(`/smartcity/drainage-permit-apply/create`, data);
  },

  // 修改排水许可证申请
  updateDrainagePermitApply: async (data: any) => {
    return await requestClient.put(`/smartcity/drainage-permit-apply/update`, data);
  },

  // 删除排水许可证申请
  deleteDrainagePermitApply: async (id: number) => {
    return await requestClient.delete(`/smartcity/drainage-permit-apply/delete`, { params: { id } });
  },

  // 导出排水许可证申请 Excel
  exportDrainagePermitApply: async (params) => {
    return await requestClient.download(`/smartcity/drainage-permit-apply/export-excel`, params);
  },
  ...
  uploadWaterQualityReport: async (file: File) => {
    ...
    return await requestClient.post(`/smartcity/drainage-permit-apply/upload`, formData, {
      headers: {
