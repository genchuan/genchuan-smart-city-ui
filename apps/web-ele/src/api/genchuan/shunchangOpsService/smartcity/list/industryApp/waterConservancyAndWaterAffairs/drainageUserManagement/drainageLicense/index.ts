...
export const DrainageLicenseApi = {
  ...
  getDrainageLicensePage: async (params: any) => {
    return await requestClient.get(`/smartcity/drainage-license/page`, { params });
  },

  // 查询排水电子许可证信息详情
  getDrainageLicense: async (id: number) => {
    return await requestClient.get(`/smartcity/drainage-license/get`, { params: { id } });
  },
  ...
  deleteDrainageLicense: async (id: number) => {
    return await requestClient.delete(`/smartcity/drainage-license/delete`, { params: { id } });
  },

  // 导出排水电子许可证信息 Excel
  exportDrainageLicense: async (params) => {
    return await requestClient.download(`/smartcity/drainage-license/export-excel`, params);
  },
};
