...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row"><div class="detail-row-left">流程状态：</div><div class="detail-row-right">{{ detailObj.processStatus || '-' }}</div></div>
      ...
      <div class="detail-section">📋 跟进记录</div>
      <div class="detail-card-row"><div class="detail-row-left">流程状态：</div><div class="detail-row-right">{{ detailObj.processStatus || '-' }}</div></div>
