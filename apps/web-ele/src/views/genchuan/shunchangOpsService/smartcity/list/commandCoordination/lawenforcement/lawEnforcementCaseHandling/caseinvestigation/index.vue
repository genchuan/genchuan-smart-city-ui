...
const getList = async () => {
  ...
  try {
    const data =
      await CaseInvestigationApi.getCaseInvestigationPage(queryParams);
...
const handleExport = async () => {
  try {
    ...
    const data =
      await CaseInvestigationApi.exportCaseInvestigation(queryParams);
