...
import { MeterUserRelationApi } from '#/api/genchuan/shunchangWaterQualityMonitor/list/meteruserrelation';
...
const handleDelete = async (id: number) => {
  try {
    // 删除的二次确认
    await confirm('是否确认删除该户表关联及变更数据？', '系统提示');
    // 发起删除
