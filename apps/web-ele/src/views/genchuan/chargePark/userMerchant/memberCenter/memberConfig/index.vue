...
import type {
  ...
  MemberConfigVO,
} from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberConfig';
...
import { MemberConfigApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberConfig';
