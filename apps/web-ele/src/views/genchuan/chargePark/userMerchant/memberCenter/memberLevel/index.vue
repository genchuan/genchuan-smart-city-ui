...
import type { MemberLevelVO } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberLevel';
...
import { MemberLevelApi } from '#/api/genchuan/chargePark/userMerchant/memberCenter/memberLevel';
