...
export function getColumns() {
  ...
  const columns = [
    ...
    { field: 'treatType', title: '就诊类型', minWidth: 100, slots: { default: 'treatType' } },
    { field: 'symptom', title: '症状描述', minWidth: 150 },
    { field: 'registerTime', title: '就诊登记时间', minWidth: 180, slots: { default: 'registerTime' } },
    { field: 'treatContent', title: '就诊内容', minWidth: 150 },
    { field: 'applyTime', title: '预约时间', minWidth: 180, slots: { default: 'applyTime' } },
    { field: 'auditUser', title: '审核人', minWidth: 100 },
    { field: 'auditTime', title: '审核时间', minWidth: 180, slots: { default: 'auditTime' } },
    { field: 'feedbackTime', title: '家长反馈时间', minWidth: 180, slots: { default: 'feedbackTime' } },
