  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="机构名称" prop="agencyName">
        <el-input v-model="formData.agencyName" placeholder="请输入机构名称" />
      </el-form-item>
      <el-form-item label="资质证书编号" prop="certificateNo">
        <el-input v-model="formData.certificateNo" placeholder="请输入资质证书编号" />
      </el-form-item>
      <el-form-item label="检测范围" prop="testingScope">
        <el-input v-model="formData.testingScope" placeholder="请输入检测范围" />
      </el-form-item>
      ...
      <el-form-item label="发证单位" prop="issuingAuthority">
        <el-input v-model="formData.issuingAuthority" placeholder="请输入发证单位" />
      </el-form-item>
    </el-form>
    <template #footer>
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as TestingAgencyVO
