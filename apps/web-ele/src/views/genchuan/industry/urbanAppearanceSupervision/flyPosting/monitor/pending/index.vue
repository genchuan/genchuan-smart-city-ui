...
<template>
  <div class="park-lot-table-new">
    ...
    <Grid>
      ...
      <template #cleanDifficultyId="{ row }">
        <el-text
          @click="handleOpenDetail(row)"
          class="common-align"
          type="primary"
        >
          {{ row.cleanDifficultyId }}
        </el-text>
      </template>

      <template #cleanerId="{ row }">
        <el-text
          @click="handleOpenDetail(row)"
          class="common-align"
          type="primary"
