...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <!-- 新增学生姓名 -->
      <div class="detail-card-row">
        <div class="detail-row-left">学生姓名：</div>
        <div class="detail-row-right">{{ detailObj.studentName || '-' }}</div>
      </div>
      <div class="detail-card-row">
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">荣誉类型：</div>
        <div class="detail-row-right">{{ detailObj.honorType || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">荣誉名称：</div>
        <div class="detail-row-right">{{ detailObj.honorName || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">获得时间：</div>
        <div class="detail-row-right">{{ formatTimestamp(detailObj.getTime) }}</div>
      </div>
      <div class="detail-card-row">
