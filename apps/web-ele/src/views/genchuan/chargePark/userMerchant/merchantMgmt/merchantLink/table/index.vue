...
} from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantLink';
...
import { MerchantLinkApi } from '#/api/genchuan/chargePark/userMerchant/merchantMgmt/merchantLink';
