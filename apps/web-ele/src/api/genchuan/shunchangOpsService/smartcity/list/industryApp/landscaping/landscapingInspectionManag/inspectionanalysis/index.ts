...
export const InspectionAnalysisApi = {
  ...
  getInspectionAnalysisPage: async (params: any) => {
    return await requestClient.get(`/smartcity/inspection-analysis/page`, {
      params,
    });
  },
  ...
  getInspectionAnalysis: async (id: number) => {
    return await requestClient.get(`/smartcity/inspection-analysis/get`, {
      params: { id },
    });
  },
  ...
  createInspectionAnalysis: async (data: any) => {
    return await requestClient.post(
      `/smartcity/inspection-analysis/create`,
      data,
    );
  },
  ...
  updateInspectionAnalysis: async (data: any) => {
    return await requestClient.put(
      `/smartcity/inspection-analysis/update`,
      data,
    );
  },
  ...
  deleteInspectionAnalysis: async (id: number) => {
    return await requestClient.delete(`/smartcity/inspection-analysis/delete`, {
      params: { id },
    });
  },
  ...
  exportInspectionAnalysis: async (params) => {
    return await requestClient.download(
      `/smartcity/inspection-analysis/export-excel`,
      params,
    );
  },
};
