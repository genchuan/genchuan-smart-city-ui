  ...
  >
    <div class="device-detail-container">
      <ElDescriptions :column="1" border>
        ...
        <ElDescriptionsItem label="供热区域">{{ detailObj.heatArea }}</ElDescriptionsItem>
        <ElDescriptionsItem label="供回水温差">{{ detailObj.tempDifference }}℃</ElDescriptionsItem>
        ...
        <ElDescriptionsItem label="季节类型">{{ detailObj.seasonType }}</ElDescriptionsItem>
        <ElDescriptionsItem label="负责检修员">{{ detailObj.staffName }}</ElDescriptionsItem>
