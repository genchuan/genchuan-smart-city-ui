...
export const ManagementOfPatrolPersonnelApi = {
  ...
  getManagementOfPatrolPersonnelPage: async (params: any) => {
    return await requestClient.get(`/smartcity/management-of-patrol-personnel/page`, { params });
  },

  // 查询巡査人员管理详情
  getManagementOfPatrolPersonnel: async (id: number) => {
    return await requestClient.get(`/smartcity/management-of-patrol-personnel/get`, { params: { id } });
  },

  // 新增巡査人员管理
  createManagementOfPatrolPersonnel: async (
    data: any,
  ) => {
    return await requestClient.post(`/smartcity/management-of-patrol-personnel/create`, data);
  },

  // 修改巡査人员管理
  updateManagementOfPatrolPersonnel: async (
    data: any,
  ) => {
    return await requestClient.put(`/smartcity/management-of-patrol-personnel/update`, data);
  },

  // 删除巡査人员管理
  deleteManagementOfPatrolPersonnel: async (id: number) => {
    return await requestClient.delete(`/smartcity/management-of-patrol-personnel/delete`, { params: { id } });
  },

  // 导出巡査人员管理 Excel
  exportManagementOfPatrolPersonnel: async (params) => {
    return await requestClient.download(`/smartcity/management-of-patrol-personnel/export-excel`, params);
  },
};
