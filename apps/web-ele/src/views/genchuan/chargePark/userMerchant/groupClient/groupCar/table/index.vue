...
import type { GroupCarDetailVO } from '#/api/genchuan/chargePark/userMerchant/groupClient/groupCar';
...
import { GroupCarApi } from '#/api/genchuan/chargePark/userMerchant/groupClient/groupCar';
import { GroupInfoApi } from '#/api/genchuan/chargePark/userMerchant/groupClient/groupInfo';
