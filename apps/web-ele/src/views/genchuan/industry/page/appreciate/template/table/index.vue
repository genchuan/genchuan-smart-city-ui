...
const getTableData = (pageObj) => {
  ...
  dataObj.total = dataObj.apilist
    ...
    .filter((v) => {
      ...
      return v.sms_type === activeName.value;
    }).length;
...
const createLabel = (item) => {
  let text = `(${dataObj.apilist.filter((v) => v.sms_type === item.label).length})`;
  if (item.label === '全部') {
      ...
      <div class="detail-card">
        <div class="detail-card-row">
          ...
          <div class="detail-row-right">
            {{ dataObj.detailObj.template_id }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">模板编码:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.template_code }}
          </div>
        </div>
        ...
        <div class="detail-card-row">
          ...
          <div class="detail-row-right">
            {{ dataObj.detailObj.template_name }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">短信类型:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.sms_type }}
          </div>
        </div>

        <div class="detail-card-row">
          <div class="detail-row-left">模板内容:</div>
          <div class="detail-row-right">
            {{ dataObj.detailObj.content }}
          </div>
        </div>
    ...
    <Grid>
      ...
      <template #bottom>
        <div class="common-total" @click="changeTotalShow">
          ...
          <span> 本页统计：模板数量: 10; 启用模板: 8; 禁用模板: 2 </span>
        </div>
