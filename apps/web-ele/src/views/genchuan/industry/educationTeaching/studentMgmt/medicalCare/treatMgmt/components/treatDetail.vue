...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      ...
      <div class="detail-card-row">
        <div class="detail-row-left">就诊类型：</div>
        <div class="detail-row-right">{{ detailObj.treatType || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">症状描述：</div>
        <div class="detail-row-right">{{ detailObj.symptom || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">就诊登记时间：</div>
        <div class="detail-row-right">{{ formatTimestamp(detailObj.registerTime) }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">就诊内容：</div>
        <div class="detail-row-right">{{ detailObj.treatContent || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">预约时间：</div>
        <div class="detail-row-right">{{ formatTimestamp(detailObj.applyTime) }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">审核人：</div>
        <div class="detail-row-right">{{ detailObj.auditUser || '-' }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">审核时间：</div>
        <div class="detail-row-right">{{ formatTimestamp(detailObj.auditTime) }}</div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">家长反馈时间：</div>
        <div class="detail-row-right">{{ formatTimestamp(detailObj.feedbackTime) }}</div>
      </div>
      <div class="detail-card-row">
