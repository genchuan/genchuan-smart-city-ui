...
const drawerTitle = computed(() => {
  const id = detailObj.value?.studentId ? `学号 ${detailObj.value.studentId} 出入申请` : '申请详情';
...
<template>
  <DetailDrawer :title="drawerTitle">
    <div class="detail-card">
      <!-- 基础信息 -->
      <div class="detail-section">📋 申请基础信息</div>
      ...
      <div class="detail-card-row"><div class="detail-row-left">申请类型：</div><div class="detail-row-right">{{ detailObj.applyType || '-' }}</div></div>
      <div class="detail-card-row"><div class="detail-row-left">申请原因：</div><div class="detail-row-right">{{ detailObj.applyReason || '-' }}</div></div>
