  ...
  <div class="park-lot-table-new">
    ...
    <Grid>
      ...
      <template #keyNode="{ row }">
        <el-tag
          :type="row.keyNode && row.keyNode.includes('促销') ? 'danger' :
                 row.keyNode && row.keyNode.includes('活动') ? 'warning' : 'info'"
          size="small"
        >
          {{ row.keyNode || '正常运营' }}
        </el-tag>
