...
import {
  dataList,
  getWorkHomePage,
} from '#/api/genchuan/educationTeaching/studentMgmt/studentWork/workHome/data.js';
import {
  textObj,
  useFormSchema,
  getColumnsByStatus,
} from '#/api/genchuan/educationTeaching/studentMgmt/studentWork/workHome/form.js';
