...
// 批量导入收运计划
export function importGarbageCollection(file) {
  const formData = new FormData();
  formData.append('file', file);
  return requestClient.post(
    '/envirhealth/garbage-collection/import',
    formData,
    {
...
// 批量更新收运计划
export function updateGarbageCollectionBatch(data) {
  return requestClient.put(
    '/envirhealth/garbage-collection/batch-update',
    data,
  );
}
...
// 批量复核异常
export function batchReviewGarbageAbnormal(data) {
  return requestClient.post('/envirhealth/garbage-abnormal/batch-review', data);
}

// 批量处理异常
export function batchHandleGarbageAbnormal(data) {
  return requestClient.post('/envirhealth/garbage-abnormal/batch-handle', data);
}
