...
<template>
  <DetailDrawer :title="title || `日收入详情 - ${detailObj.areaName} ${detailObj.parkType}`">
    <div class="detail-card">
        ...
        <div class="detail-row-right">
          <el-tag
            :type="detailObj.payWay === '微信支付' ? 'success' :
                   ...
                   detailObj.payWay === '现金支付' ? 'warning' : 'info'"
            size="small"
          >
            {{ detailObj.payWay }}
          </el-tag>
      ...
      <div class="detail-card-row">
        ...
        <div class="detail-row-right">
          <el-tag type="primary" size="small">
            {{ detailObj.orderCount }}
          </el-tag>
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">平均客单价:</div>
        <div class="detail-row-right">
          <el-tag type="warning" size="small">
            ¥{{ detailObj.avgOrderAmount?.toFixed(2) }}
          </el-tag>
        </div>
      </div>
      <div class="detail-card-row">
        <div class="detail-row-left">线上支付占比:</div>
        <div class="detail-row-right">
          <el-tag type="info" size="small">
            {{ detailObj.onlinePayRatio }}%
          </el-tag>
        </div>
      </div>
      <div class="detail-card-row">
