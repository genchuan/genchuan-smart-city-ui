...
import markerEmergency from '../images/risk-high.png'; // 紧急故障红标
import markerNormal from '../images/risk-mid.png';       // 一般故障橙标
import markerHandled from '../images/normal.png';     // 已处置绿标
import markerGray from '../images/marker-gray.png';    // 默认灰标

import markerManholeEmergency from '../images/manhole-emergency.png'; // 井盖-紧急故障
import markerManholeNormal from '../images/manhole-normal.png';       // 井盖-一般故障
import markerManholeHandled from '../images/manhole-handled.png';     // 井盖-已处置

import markerStreetlightEmergency from '../images/streetlight-emergency.png'; // 路灯-紧急故障
import markerStreetlightNormal from '../images/streetlight-normal.png';       // 路灯-一般故障
import markerStreetlightHandled from '../images/streetlight-handled.png';     // 路灯-已处置

import markerPipeNetworkEmergency from '../images/pipeNetwork-emergency.png'; // 管网-紧急故障
import markerPipeNetworkNormal from '../images/pipeNetwork-normal.png';       // 管网-一般故障
import markerPipeNetworkHandled from '../images/pipeNetwork-handled.png';     // 管网-已处置

import markerFireHydrantEmergency from '../images/fireHydrant-emergency.png'; // 消防栓-紧急故障
import markerFireHydrantNormal from '../images/fireHydrant-normal.png';       // 消防栓-一般故障
import markerFireHydrantHandled from '../images/fireHydrant-handled.png';     // 消防栓-已处置

import markerTrashCanEmergency from '../images/trashCan-emergency.png'; // 垃圾桶-紧急故障
import markerTrashCanNormal from '../images/trashCan-normal.png';       // 垃圾桶-一般故障
import markerTrashCanHandled from '../images/trashCan-handled.png';     // 垃圾桶-已处置
