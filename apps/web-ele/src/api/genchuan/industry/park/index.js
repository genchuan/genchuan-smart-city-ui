...
export function getInputCar(params) {
  return requestClient.get('/park/input-car/page', {
    params,
  });
}
...
export function updatecarInput(data) {
  return requestClient.put('/park/input-car/update', data);
}
/** 车辆出场创建记录 */
...
export function getHistroyList(targetBerthNo, parkingStatus, parkId) {
  return requestClient.get(
    `/park/input-car/history-by-berth?targetBerthNo=${targetBerthNo}&parkingStatus=${parkingStatus}&parkId=${parkId}`,
  );
}
...
export function simulateMagneticDetection(data) {
  return requestClient.post(
    '/park/input-car/simulate-magnetic-detection',
    data,
  );
}
...
export function outPark(data) {
  return requestClient.post(
    '/park/input-car/simulate-magnetic-detection-exit',
    data,
  );
}
/**
