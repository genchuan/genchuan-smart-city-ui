...
export function useFormSchema() {
  return [
    ...
    { fieldName: 'merchantName', label: '商户名称', component: 'Input', componentProps: { placeholder: '请输入商户名称', clearable: true }, isSearch: true },
...
export function useGridColumns({ getUserName, getMerchantName }) {
  return [
    ...
    { field: 'progress', title: '调解进度', minWidth: 200, slots: { default: 'progress' } },
